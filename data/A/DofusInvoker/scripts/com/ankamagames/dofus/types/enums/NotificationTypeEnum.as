package com.ankamagames.dofus.types.enums
{
   public class NotificationTypeEnum
   {
      ...
      public static const JOB_INFORMATION:uint = 4;
      ...
      public static const GENERAL_INFORMATION:uint = 8;
      
      public static const NOTIFICATION_PRIORITY:Array = [NotificationTypeEnum.ERROR,NotificationTypeEnum.WARNING,NotificationTypeEnum.PRIORITY_INVITATION,NotificationTypeEnum.INVITATION,NotificationTypeEnum.SERVER_INFORMATION,NotificationTypeEnum.GENERAL_INFORMATION,NotificationTypeEnum.JOB_INFORMATION,NotificationTypeEnum.TUTORIAL,NotificationTypeEnum.SURVEY_INVITATION];
