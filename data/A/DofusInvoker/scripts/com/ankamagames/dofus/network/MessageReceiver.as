package com.ankamagames.dofus.network
{
   ...
   public class MessageReceiver implements RawDataParser
   {
      ...
      {
         _messagesTypes[684] = PaginationAnswerAbstractMessage;
         _messagesTypes[74] = NetworkDataContainerMessage;
         _messagesTypes[6212] = ProtocolRequired;
         _messagesTypes[6831] = LoginQueueStatusMessage;
         _messagesTypes[3069] = QueueStatusMessage;
         _messagesTypes[3687] = ConsoleMessage;
         _messagesTypes[2726] = ConsoleEndMessage;
         _messagesTypes[467] = ConsoleCommandsListMessage;
         _messagesTypes[7439] = HelloConnectMessage;
         _messagesTypes[4271] = CredentialsAcknowledgementMessage;
         _messagesTypes[2411] = NicknameRegistrationMessage;
         _messagesTypes[7805] = AccountLinkRequiredMessage;
         _messagesTypes[1947] = NicknameRefusedMessage;
         _messagesTypes[1279] = NicknameAcceptedMessage;
         _messagesTypes[1693] = IdentificationSuccessMessage;
         _messagesTypes[5913] = ForceAccountErrorMessage;
         _messagesTypes[2493] = ForceAccountStatusMessage;
         _messagesTypes[5993] = IdentificationSuccessWithLoginTokenMessage;
         _messagesTypes[4905] = IdentificationFailedMessage;
         _messagesTypes[2849] = IdentificationFailedBannedMessage;
         _messagesTypes[7224] = IdentificationFailedForBadVersionMessage;
         _messagesTypes[8557] = ServersListMessage;
         _messagesTypes[3516] = ServerStatusUpdateMessage;
         _messagesTypes[2882] = SelectedServerDataMessage;
         _messagesTypes[7910] = SelectedServerDataExtendedMessage;
         _messagesTypes[6476] = SelectedServerRefusedMessage;
         _messagesTypes[8575] = AcquaintanceSearchErrorMessage;
         _messagesTypes[6172] = AcquaintanceServerListMessage;
         _messagesTypes[6615] = MigratedServerListMessage;
         _messagesTypes[6694] = HelloGameMessage;
         _messagesTypes[9044] = AuthenticationTicketAcceptedMessage;
         _messagesTypes[396] = AuthenticationTicketRefusedMessage;
         _messagesTypes[2000] = AlreadyConnectedMessage;
         _messagesTypes[1530] = AccountLoggingKickedMessage;
         _messagesTypes[3729] = ReloginTokenStatusMessage;
         _messagesTypes[666] = ServerSettingsMessage;
         _messagesTypes[3329] = ServerSessionConstantsMessage;
         _messagesTypes[5407] = ServerOptionalFeaturesMessage;
         _messagesTypes[7413] = AccountCapabilitiesMessage;
         _messagesTypes[2545] = TrustStatusMessage;
         _messagesTypes[1918] = AccountInformationsUpdateMessage;
         _messagesTypes[2671] = AccountSubscriptionElapsedDurationMessage;
         _messagesTypes[7581] = CheckFileRequestMessage;
         _messagesTypes[6164] = RawDataMessage;
         _messagesTypes[1840] = GameActionItemListMessage;
         _messagesTypes[7743] = GameActionItemAddMessage;
         _messagesTypes[665] = GameActionItemConsumedMessage;
         _messagesTypes[3594] = CharacterCanBeCreatedResultMessage;
         _messagesTypes[1293] = CharacterCreationResultMessage;
         _messagesTypes[4740] = CharacterDeletionPrepareMessage;
         _messagesTypes[9555] = CharacterDeletionErrorMessage;
         _messagesTypes[5866] = CharacterNameSuggestionSuccessMessage;
         _messagesTypes[3159] = CharacterNameSuggestionFailureMessage;
         _messagesTypes[1165] = CharactersListMessage;
         _messagesTypes[6834] = CharactersListWithRemodelingMessage;
         _messagesTypes[6817] = CharactersListErrorMessage;
         _messagesTypes[9868] = CharacterSelectedSuccessMessage;
         _messagesTypes[1675] = CharacterSelectedForceMessage;
         _messagesTypes[7442] = CharacterSelectedErrorMessage;
         _messagesTypes[3812] = PopupWarningMessage;
         _messagesTypes[3684] = PopupWarningClosedMessage;
         _messagesTypes[9400] = BasicDateMessage;
         _messagesTypes[6808] = BasicTimeMessage;
         _messagesTypes[1985] = AlmanachCalendarDateMessage;
         _messagesTypes[7318] = BasicNoOperationMessage;
         _messagesTypes[9898] = BasicAckMessage;
         _messagesTypes[6724] = SystemMessageDisplayMessage;
         _messagesTypes[8680] = TextInformationMessage;
         _messagesTypes[2704] = OnConnectionEventMessage;
         _messagesTypes[2350] = SetCharacterRestrictionsMessage;
         _messagesTypes[1898] = ServerExperienceModificatorMessage;
         _messagesTypes[7400] = CharacterCapabilitiesMessage;
         _messagesTypes[7308] = CharacterLoadingCompleteMessage;
         _messagesTypes[1030] = GameContextCreateMessage;
         _messagesTypes[1618] = GameContextCreateErrorMessage;
         _messagesTypes[7633] = GameContextDestroyMessage;
         _messagesTypes[4327] = GameContextRemoveElementMessage;
         _messagesTypes[9694] = GameContextRemoveMultipleElementsMessage;
         _messagesTypes[5650] = GameContextRemoveElementWithEventMessage;
         _messagesTypes[4936] = GameContextRemoveMultipleElementsWithEventsMessage;
         _messagesTypes[5773] = GameContextMoveElementMessage;
         _messagesTypes[2316] = GameContextMoveMultipleElementsMessage;
         _messagesTypes[4697] = GameContextRefreshEntityLookMessage;
         _messagesTypes[8603] = GameMapNoMovementMessage;
         _messagesTypes[5371] = GameMapMovementMessage;
         _messagesTypes[3062] = GameCautiousMapMovementMessage;
         _messagesTypes[9176] = GameMapChangeOrientationMessage;
         _messagesTypes[443] = GameMapChangeOrientationsMessage;
         _messagesTypes[4159] = GameEntityDispositionMessage;
         _messagesTypes[5409] = GameEntitiesDispositionMessage;
         _messagesTypes[9550] = GameEntityDispositionErrorMessage;
         _messagesTypes[9112] = GameRefreshMonsterBoostsMessage;
         _messagesTypes[1388] = PlayerStatusUpdateErrorMessage;
         _messagesTypes[4865] = PlayerStatusUpdateMessage;
         _messagesTypes[276] = BasicWhoIsMessage;
         _messagesTypes[2022] = BasicWhoIsNoMatchMessage;
         _messagesTypes[1271] = NumericWhoIsMessage;
         _messagesTypes[8522] = BasicPongMessage;
         _messagesTypes[9879] = BasicLatencyStatsRequestMessage;
         _messagesTypes[1620] = SequenceNumberRequestMessage;
         _messagesTypes[8289] = CurrentServerStatusUpdateMessage;
         _messagesTypes[6712] = CinematicMessage;
         _messagesTypes[9489] = DumpedEntityStatsMessage;
         _messagesTypes[4666] = DebugHighlightCellsMessage;
         _messagesTypes[3527] = DebugClearHighlightCellsMessage;
         _messagesTypes[6441] = DebugInClientMessage;
         _messagesTypes[4772] = ClientYouAreDrunkMessage;
         _messagesTypes[9965] = DisplayNumericalValuePaddockMessage;
         _messagesTypes[6179] = CurrentMapMessage;
         _messagesTypes[5946] = CurrentMapInstanceMessage;
         _messagesTypes[67] = TeleportOnSameMapMessage;
         _messagesTypes[1874] = MapFightCountMessage;
         _messagesTypes[4506] = MapRunningFightListMessage;
         _messagesTypes[857] = MapRunningFightDetailsMessage;
         _messagesTypes[6894] = MapRunningFightDetailsExtendedMessage;
         _messagesTypes[1326] = MapObstacleUpdateMessage;
         _messagesTypes[7827] = MapComplementaryInformationsDataMessage;
         _messagesTypes[6407] = MapComplementaryInformationsDataInHouseMessage;
         _messagesTypes[2204] = MapComplementaryInformationsWithCoordsMessage;
         _messagesTypes[8472] = SubareaRewardRateMessage;
         _messagesTypes[9638] = BreachEnterMessage;
         _messagesTypes[6396] = BreachTeleportResponseMessage;
         _messagesTypes[6303] = BreachRoomLockedMessage;
         _messagesTypes[5482] = BreachRoomUnlockResultMessage;
         _messagesTypes[3791] = BreachExitResponseMessage;
         _messagesTypes[3679] = MapComplementaryInformationsBreachMessage;
         _messagesTypes[5018] = BreachGameFightEndMessage;
         _messagesTypes[8450] = AnomalyStateMessage;
         _messagesTypes[9809] = AnomalyOpenedMessage;
         _messagesTypes[6795] = MapComplementaryInformationsAnomalyMessage;
         _messagesTypes[6803] = MapFightStartPositionsUpdateMessage;
         _messagesTypes[6727] = GameRolePlayShowActorMessage;
         _messagesTypes[8292] = GameRolePlayShowMultipleActorsMessage;
         _messagesTypes[5437] = GameRolePlayShowActorWithEventMessage;
         _messagesTypes[5364] = CharacterStatsListMessage;
         _messagesTypes[6208] = FighterStatsListMessage;
         _messagesTypes[3375] = ApplySpellModifierMessage;
         _messagesTypes[8534] = RemoveSpellModifierMessage;
         _messagesTypes[246] = CharacterLevelUpMessage;
         _messagesTypes[9486] = CharacterExperienceGainMessage;
         _messagesTypes[2236] = CharacterLevelUpInformationMessage;
         _messagesTypes[6486] = UpdateLifePointsMessage;
         _messagesTypes[4586] = LifePointsRegenBeginMessage;
         _messagesTypes[6111] = LifePointsRegenEndMessage;
         _messagesTypes[3943] = GameRolePlayPlayerLifeStatusMessage;
         _messagesTypes[1042] = GameRolePlayGameOverMessage;
         _messagesTypes[2155] = GameRolePlayFightRequestCanceledMessage;
         _messagesTypes[1812] = GameRolePlayAggressionMessage;
         _messagesTypes[817] = GameRolePlayPlayerFightFriendlyRequestedMessage;
         _messagesTypes[8186] = GameRolePlayPlayerFightFriendlyAnsweredMessage;
         _messagesTypes[2179] = GameRolePlayArenaRegistrationStatusMessage;
         _messagesTypes[9895] = GameRolePlayArenaFightPropositionMessage;
         _messagesTypes[6108] = GameRolePlayArenaFighterStatusMessage;
         _messagesTypes[7553] = GameRolePlayArenaUpdatePlayerInfosMessage;
         _messagesTypes[9681] = GameRolePlayArenaUpdatePlayerInfosAllQueuesMessage;
         _messagesTypes[2464] = GameRolePlayArenaSwitchToFightServerMessage;
         _messagesTypes[7067] = GameRolePlayArenaSwitchToGameServerMessage;
         _messagesTypes[3303] = GameRolePlayArenaInvitationCandidatesAnswerMessage;
         _messagesTypes[8190] = GameRolePlayArenaLeagueRewardsMessage;
         _messagesTypes[9801] = GameRolePlayArenaPlayerBehavioursMessage;
         _messagesTypes[3851] = GameRolePlayArenaRegistrationWarningMessage;
         _messagesTypes[6101] = GameRolePlayMonsterAngryAtPlayerMessage;
         _messagesTypes[1350] = GameRolePlayMonsterNotAngryAtPlayerMessage;
         _messagesTypes[1128] = GameRolePlayShowChallengeMessage;
         _messagesTypes[2068] = GameRolePlayRemoveChallengeMessage;
         _messagesTypes[8399] = GameRolePlaySpellAnimMessage;
         _messagesTypes[374] = GameRolePlayDelayedActionMessage;
         _messagesTypes[1277] = GameRolePlayDelayedObjectUseMessage;
         _messagesTypes[205] = GameRolePlayDelayedActionFinishedMessage;
         _messagesTypes[1929] = ShowCellMessage;
         _messagesTypes[6981] = ShowCellSpectatorMessage;
         _messagesTypes[2894] = GameFightStartingMessage;
         _messagesTypes[4031] = GameFightJoinMessage;
         _messagesTypes[8433] = GameFightSpectatorJoinMessage;
         _messagesTypes[2660] = GameFightPlacementPossiblePositionsMessage;
         _messagesTypes[8987] = GameFightPlacementSwapPositionsErrorMessage;
         _messagesTypes[5101] = GameFightPlacementSwapPositionsOfferMessage;
         _messagesTypes[4319] = GameFightPlacementSwapPositionsCancelledMessage;
         _messagesTypes[9575] = GameFightPlacementSwapPositionsMessage;
         _messagesTypes[9413] = GameFightOptionStateUpdateMessage;
         _messagesTypes[9948] = GameFightUpdateTeamMessage;
         _messagesTypes[5968] = GameFightRemoveTeamMemberMessage;
         _messagesTypes[2393] = GameFightHumanReadyStateMessage;
         _messagesTypes[8511] = GameFightLeaveMessage;
         _messagesTypes[5363] = GameFightStartMessage;
         _messagesTypes[4198] = GameFightSpectateMessage;
         _messagesTypes[9492] = GameFightResumeMessage;
         _messagesTypes[4285] = GameFightResumeWithSlavesMessage;
         _messagesTypes[9234] = GameFightEndMessage;
         _messagesTypes[4570] = GameFightNewRoundMessage;
         _messagesTypes[2971] = GameFightTurnListMessage;
         _messagesTypes[853] = GameFightTurnStartMessage;
         _messagesTypes[2674] = GameFightNewWaveMessage;
         _messagesTypes[3743] = GameFightTurnStartPlayingMessage;
         _messagesTypes[737] = GameFightTurnResumeMessage;
         _messagesTypes[6176] = GameFightPauseMessage;
         _messagesTypes[7542] = SlaveSwitchContextMessage;
         _messagesTypes[5973] = SlaveNoLongerControledMessage;
         _messagesTypes[1113] = RefreshCharacterStatsMessage;
         _messagesTypes[3587] = GameFightTurnReadyRequestMessage;
         _messagesTypes[4330] = GameFightSynchronizeMessage;
         _messagesTypes[6874] = GameFightTurnEndMessage;
         _messagesTypes[4590] = GameFightShowFighterMessage;
         _messagesTypes[6382] = GameFightRefreshFighterMessage;
         _messagesTypes[6063] = GameFightShowFighterRandomStaticPoseMessage;
         _messagesTypes[6628] = ArenaFighterLeaveMessage;
         _messagesTypes[2834] = ArenaFighterIdleMessage;
         _messagesTypes[7373] = SequenceStartMessage;
         _messagesTypes[5597] = SequenceEndMessage;
         _messagesTypes[1587] = AbstractGameActionMessage;
         _messagesTypes[9834] = GameActionNoopMessage;
         _messagesTypes[981] = GameActionSpamMessage;
         _messagesTypes[1235] = AbstractGameActionWithAckMessage;
         _messagesTypes[580] = GameActionFightNoSpellCastMessage;
         _messagesTypes[6925] = AbstractGameActionFightTargetedAbilityMessage;
         _messagesTypes[7293] = GameActionFightSpellCastMessage;
         _messagesTypes[7028] = GameActionFightCloseCombatMessage;
         _messagesTypes[8307] = GameActionUpdateEffectTriggerCountMessage;
         _messagesTypes[9477] = GameActionFightInvisibleDetectedMessage;
         _messagesTypes[3067] = GameActionFightPointsVariationMessage;
         _messagesTypes[2500] = GameActionFightTackledMessage;
         _messagesTypes[6768] = GameActionFightDeathMessage;
         _messagesTypes[2868] = GameActionFightKillMessage;
         _messagesTypes[6578] = GameActionFightVanishMessage;
         _messagesTypes[3757] = GameActionFightSpellCooldownVariationMessage;
         _messagesTypes[1777] = GameActionFightSpellImmunityMessage;
         _messagesTypes[9548] = GameActionFightLifePointsGainMessage;
         _messagesTypes[5631] = GameActionFightLifePointsLostMessage;
         _messagesTypes[3819] = GameActionFightLifeAndShieldPointsLostMessage;
         _messagesTypes[359] = GameActionFightDispellableEffectMessage;
         _messagesTypes[7496] = GameActionFightReflectSpellMessage;
         _messagesTypes[2417] = GameActionFightReduceDamagesMessage;
         _messagesTypes[3385] = GameActionFightReflectDamagesMessage;
         _messagesTypes[2467] = GameActionFightDodgePointLossMessage;
         _messagesTypes[6577] = GameActionFightSlideMessage;
         _messagesTypes[2880] = GameActionFightTeleportOnSameMapMessage;
         _messagesTypes[7480] = GameActionFightExchangePositionsMessage;
         _messagesTypes[1589] = GameActionFightDispellMessage;
         _messagesTypes[5642] = GameActionFightDispellEffectMessage;
         _messagesTypes[1891] = GameActionFightDispellSpellMessage;
         _messagesTypes[3507] = GameActionFightModifyEffectsDurationMessage;
         _messagesTypes[3760] = GameActionFightTriggerEffectMessage;
         _messagesTypes[7252] = GameActionFightStealKamaMessage;
         _messagesTypes[8061] = GameActionFightChangeLookMessage;
         _messagesTypes[4532] = GameActionFightInvisibilityMessage;
         _messagesTypes[3204] = GameActionFightSummonMessage;
         _messagesTypes[7441] = GameActionFightMultipleSummonMessage;
         _messagesTypes[9871] = GameActionFightMarkCellsMessage;
         _messagesTypes[6450] = GameActionFightUnmarkCellsMessage;
         _messagesTypes[5767] = GameActionFightTriggerGlyphTrapMessage;
         _messagesTypes[7240] = GameActionFightActivateGlyphTrapMessage;
         _messagesTypes[6968] = GameActionFightCarryCharacterMessage;
         _messagesTypes[7663] = GameActionFightThrowCharacterMessage;
         _messagesTypes[9220] = GameActionFightDropCharacterMessage;
         _messagesTypes[8072] = EmoteListMessage;
         _messagesTypes[5327] = EmoteAddMessage;
         _messagesTypes[3801] = EmoteRemoveMessage;
         _messagesTypes[8789] = EmotePlayAbstractMessage;
         _messagesTypes[452] = EmotePlayMessage;
         _messagesTypes[7754] = EmotePlayMassiveMessage;
         _messagesTypes[1816] = EmotePlayErrorMessage;
         _messagesTypes[2840] = ChatSmileyMessage;
         _messagesTypes[9321] = ChatCommunityChannelCommunityMessage;
         _messagesTypes[4314] = LocalizedChatSmileyMessage;
         _messagesTypes[4457] = MoodSmileyResultMessage;
         _messagesTypes[2589] = MoodSmileyUpdateMessage;
         _messagesTypes[1310] = ChatSmileyExtraPackListMessage;
         _messagesTypes[5870] = ChatAbstractServerMessage;
         _messagesTypes[8812] = ChatServerMessage;
         _messagesTypes[9633] = ChatKolizeumServerMessage;
         _messagesTypes[5567] = ChatAdminServerMessage;
         _messagesTypes[1391] = ChatServerWithObjectMessage;
         _messagesTypes[5601] = ChatServerCopyMessage;
         _messagesTypes[5448] = ChatServerCopyWithObjectMessage;
         _messagesTypes[4200] = ChatErrorMessage;
         _messagesTypes[4844] = EnabledChannelsMessage;
         _messagesTypes[9246] = ChannelEnablingChangeMessage;
         _messagesTypes[7309] = SpellListMessage;
         _messagesTypes[5] = ForgettableSpellListUpdateMessage;
         _messagesTypes[3198] = ForgettableSpellDeleteMessage;
         _messagesTypes[2801] = ForgettableSpellEquipmentSlotsMessage;
         _messagesTypes[2479] = LeaveDialogMessage;
         _messagesTypes[6393] = PauseDialogMessage;
         _messagesTypes[3657] = InteractiveUseErrorMessage;
         _messagesTypes[8434] = InteractiveUsedMessage;
         _messagesTypes[5647] = InteractiveUseEndedMessage;
         _messagesTypes[9777] = InteractiveMapUpdateMessage;
         _messagesTypes[6384] = StatedMapUpdateMessage;
         _messagesTypes[6876] = InteractiveElementUpdatedMessage;
         _messagesTypes[5876] = StatedElementUpdatedMessage;
         _messagesTypes[6953] = ZaapRespawnUpdatedMessage;
         _messagesTypes[9458] = TeleportDestinationsMessage;
         _messagesTypes[5427] = ZaapDestinationsMessage;
         _messagesTypes[974] = KnownZaapListMessage;
         _messagesTypes[6786] = TeleportBuddiesMessage;
         _messagesTypes[5405] = TeleportBuddiesRequestedMessage;
         _messagesTypes[1630] = TeleportToBuddyOfferMessage;
         _messagesTypes[2748] = TeleportToBuddyCloseMessage;
         _messagesTypes[253] = TeleportPlayerOfferMessage;
         _messagesTypes[138] = TeleportPlayerCloseMessage;
         _messagesTypes[6158] = GroupTeleportPlayerOfferMessage;
         _messagesTypes[4498] = GroupTeleportPlayerCloseMessage;
         _messagesTypes[656] = SpellVariantActivationMessage;
         _messagesTypes[5392] = StatsUpgradeResultMessage;
         _messagesTypes[8911] = ChallengeListMessage;
         _messagesTypes[9041] = ChallengeTargetsMessage;
         _messagesTypes[1032] = ChallengeResultMessage;
         _messagesTypes[2835] = ChallengeNumberMessage;
         _messagesTypes[833] = ChallengeProposalMessage;
         _messagesTypes[152] = ChallengeSelectedMessage;
         _messagesTypes[838] = ChallengeAddMessage;
         _messagesTypes[1467] = ChallengeModSelectedMessage;
         _messagesTypes[593] = ChallengeBonusChoiceSelectedMessage;
         _messagesTypes[3235] = EntityInformationMessage;
         _messagesTypes[4988] = EntitiesInformationMessage;
         _messagesTypes[8158] = AchievementListMessage;
         _messagesTypes[2146] = AchievementDetailsMessage;
         _messagesTypes[4505] = AchievementDetailedListMessage;
         _messagesTypes[211] = AchievementAlmostFinishedDetailedListMessage;
         _messagesTypes[9364] = AchievementFinishedMessage;
         _messagesTypes[7605] = AchievementFinishedInformationMessage;
         _messagesTypes[3454] = AchievementRewardSuccessMessage;
         _messagesTypes[8876] = AchievementRewardErrorMessage;
         _messagesTypes[8341] = FriendGuildWarnOnAchievementCompleteStateMessage;
         _messagesTypes[1249] = DungeonKeyRingMessage;
         _messagesTypes[6442] = DungeonKeyRingUpdateMessage;
         _messagesTypes[5499] = UpdateMapPlayersAgressableStatusMessage;
         _messagesTypes[8060] = UpdateSelfAgressableStatusMessage;
         _messagesTypes[3325] = AlignmentRankUpdateMessage;
         _messagesTypes[9501] = CompassResetMessage;
         _messagesTypes[7152] = CompassUpdateMessage;
         _messagesTypes[7789] = CompassUpdatePartyMemberMessage;
         _messagesTypes[6927] = AtlasPointInformationsMessage;
         _messagesTypes[4641] = CompassUpdatePvpSeekMessage;
         _messagesTypes[7810] = AbstractPartyMessage;
         _messagesTypes[463] = AbstractPartyEventMessage;
         _messagesTypes[315] = PartyModifiableStatusMessage;
         _messagesTypes[7179] = PartyInvitationMessage;
         _messagesTypes[6593] = PartyInvitationDungeonMessage;
         _messagesTypes[7267] = PartyInvitationDetailsMessage;
         _messagesTypes[8298] = PartyInvitationDungeonDetailsMessage;
         _messagesTypes[5256] = PartyInvitationCancelledForGuestMessage;
         _messagesTypes[2898] = PartyCancelInvitationNotificationMessage;
         _messagesTypes[3378] = PartyRefuseInvitationNotificationMessage;
         _messagesTypes[4742] = PartyCannotJoinErrorMessage;
         _messagesTypes[608] = PartyJoinMessage;
         _messagesTypes[3268] = PartyNewGuestMessage;
         _messagesTypes[9642] = PartyUpdateMessage;
         _messagesTypes[5976] = PartyNewMemberMessage;
         _messagesTypes[9153] = PartyUpdateLightMessage;
         _messagesTypes[3217] = PartyEntityUpdateLightMessage;
         _messagesTypes[3473] = PartyMemberRemoveMessage;
         _messagesTypes[4249] = PartyMemberEjectedMessage;
         _messagesTypes[4973] = PartyLeaderUpdateMessage;
         _messagesTypes[2782] = PartyFollowStatusUpdateMessage;
         _messagesTypes[3224] = PartyLocateMembersMessage;
         _messagesTypes[9346] = PartyLeaveMessage;
         _messagesTypes[518] = PartyKickedByMessage;
         _messagesTypes[904] = PartyRestrictedMessage;
         _messagesTypes[2103] = PartyDeletedMessage;
         _messagesTypes[3619] = PartyLoyaltyStatusMessage;
         _messagesTypes[6717] = AbstractPartyMemberInFightMessage;
         _messagesTypes[3252] = PartyMemberInStandardFightMessage;
         _messagesTypes[4267] = PartyMemberInBreachFightMessage;
         _messagesTypes[8601] = PartyNameUpdateMessage;
         _messagesTypes[5132] = PartyNameSetErrorMessage;
         _messagesTypes[5103] = DungeonPartyFinderAvailableDungeonsMessage;
         _messagesTypes[9974] = DungeonPartyFinderListenErrorMessage;
         _messagesTypes[9218] = DungeonPartyFinderRoomContentMessage;
         _messagesTypes[3247] = DungeonPartyFinderRoomContentUpdateMessage;
         _messagesTypes[9991] = DungeonPartyFinderRegisterSuccessMessage;
         _messagesTypes[7570] = DungeonPartyFinderRegisterErrorMessage;
         _messagesTypes[3114] = ContactAddFailureMessage;
         _messagesTypes[1558] = SpouseStatusMessage;
         _messagesTypes[8697] = FriendsListMessage;
         _messagesTypes[1493] = AcquaintancesListMessage;
         _messagesTypes[940] = SpouseInformationsMessage;
         _messagesTypes[1764] = FriendAddFailureMessage;
         _messagesTypes[4660] = AcquaintanceAddedMessage;
         _messagesTypes[2637] = FriendAddedMessage;
         _messagesTypes[7520] = FriendUpdateMessage;
         _messagesTypes[1285] = FriendDeleteResultMessage;
         _messagesTypes[2351] = FriendWarnOnConnectionStateMessage;
         _messagesTypes[2109] = WarnOnPermaDeathStateMessage;
         _messagesTypes[6879] = FriendWarnOnLevelGainStateMessage;
         _messagesTypes[2156] = FriendStatusShareStateMessage;
         _messagesTypes[390] = IgnoredListMessage;
         _messagesTypes[6018] = IgnoredAddFailureMessage;
         _messagesTypes[1789] = IgnoredAddedMessage;
         _messagesTypes[6348] = IgnoredDeleteResultMessage;
         _messagesTypes[2616] = KohUpdateMessage;
         _messagesTypes[279] = KothEndMessage;
         _messagesTypes[7140] = AreaFightModificatorUpdateMessage;
         _messagesTypes[127] = ClientUIOpenedMessage;
         _messagesTypes[7285] = ClientUIOpenedByObjectMessage;
         _messagesTypes[9928] = GuildListMessage;
         _messagesTypes[3547] = GuildLogbookInformationMessage;
         _messagesTypes[3046] = GuildChestTabContributionsMessage;
         _messagesTypes[9522] = GuildChestTabLastContributionMessage;
         _messagesTypes[575] = GuildChestTabContributionMessage;
         _messagesTypes[5890] = GuildSummaryMessage;
         _messagesTypes[1527] = GuildCreationStartedMessage;
         _messagesTypes[4998] = GuildModificationStartedMessage;
         _messagesTypes[6753] = GuildCreationResultMessage;
         _messagesTypes[9656] = GuildModificationResultMessage;
         _messagesTypes[2309] = GuildInvitedMessage;
         _messagesTypes[9306] = GuildInvitationStateRecruterMessage;
         _messagesTypes[6706] = GuildInvitationStateRecrutedMessage;
         _messagesTypes[3312] = GuildJoinedMessage;
         _messagesTypes[5406] = GuildMemberOnlineStatusMessage;
         _messagesTypes[2977] = GuildInformationsGeneralMessage;
         _messagesTypes[3923] = GuildInformationsMembersMessage;
         _messagesTypes[3949] = GuildInformationsMemberUpdateMessage;
         _messagesTypes[7232] = GuildInformationsPaddocksMessage;
         _messagesTypes[5519] = GuildMemberLeavingMessage;
         _messagesTypes[3068] = GuildLeftMessage;
         _messagesTypes[4732] = GuildMembershipMessage;
         _messagesTypes[5362] = GuildLevelUpMessage;
         _messagesTypes[8768] = GuildHousesInformationMessage;
         _messagesTypes[5756] = GuildHouseUpdateInformationMessage;
         _messagesTypes[9226] = GuildHouseRemoveMessage;
         _messagesTypes[8362] = GuildPaddockBoughtMessage;
         _messagesTypes[6824] = GuildPaddockRemovedMessage;
         _messagesTypes[4019] = GuildMotdMessage;
         _messagesTypes[923] = GuildMotdSetErrorMessage;
         _messagesTypes[6462] = GuildBulletinMessage;
         _messagesTypes[274] = GuildBulletinSetErrorMessage;
         _messagesTypes[1226] = GuildFactsErrorMessage;
         _messagesTypes[2978] = GuildFactsMessage;
         _messagesTypes[4603] = GuildRanksMessage;
         _messagesTypes[5182] = AllianceCreationStartedMessage;
         _messagesTypes[7194] = AllianceModificationStartedMessage;
         _messagesTypes[1866] = AllianceCreationResultMessage;
         _messagesTypes[9478] = AllianceModificationResultMessage;
         _messagesTypes[6730] = AllianceMemberOnlineStatusMessage;
         _messagesTypes[2941] = AllianceApplicationDeletedMessage;
         _messagesTypes[9618] = AlliancePlayerApplicationAbstractMessage;
         _messagesTypes[547] = AlliancePlayerApplicationInformationMessage;
         _messagesTypes[4726] = AlliancePlayerNoApplicationInformationMessage;
         _messagesTypes[7178] = AllianceApplicationIsAnsweredMessage;
         _messagesTypes[4761] = AllianceListApplicationAnswerMessage;
         _messagesTypes[3825] = AllianceListApplicationModifiedMessage;
         _messagesTypes[3019] = AllianceApplicationReceivedMessage;
         _messagesTypes[9984] = AllianceApplicationPresenceMessage;
         _messagesTypes[7838] = AllianceRecruitmentInformationMessage;
         _messagesTypes[9451] = AllianceRecruitmentInvalidateMessage;
         _messagesTypes[4184] = AllianceInvitedMessage;
         _messagesTypes[420] = AllianceInvitationStateRecruterMessage;
         _messagesTypes[415] = AllianceInvitationStateRecrutedMessage;
         _messagesTypes[1961] = AllianceJoinedMessage;
         _messagesTypes[7180] = AllianceMemberLeavingMessage;
         _messagesTypes[4026] = AllianceLeftMessage;
         _messagesTypes[9929] = AllianceMembershipMessage;
         _messagesTypes[3233] = AllianceSummaryMessage;
         _messagesTypes[3553] = AllianceFactsErrorMessage;
         _messagesTypes[4583] = AllianceFactsMessage;
         _messagesTypes[9967] = AllianceRanksMessage;
         _messagesTypes[267] = AllianceMemberInformationUpdateMessage;
         _messagesTypes[8023] = AllianceListMessage;
         _messagesTypes[2603] = AlliancePartialListMessage;
         _messagesTypes[2852] = AllianceInsiderInfoMessage;
         _messagesTypes[345] = AllianceFightInfoMessage;
         _messagesTypes[9739] = AllianceFightStartedMessage;
         _messagesTypes[6051] = AllianceFightFinishedMessage;
         _messagesTypes[3598] = AllianceFightPhaseUpdateMessage;
         _messagesTypes[394] = AllianceFightFighterAddedMessage;
         _messagesTypes[2878] = AllianceFightFighterRemovedMessage;
         _messagesTypes[6865] = AllianceMotdMessage;
         _messagesTypes[9466] = AllianceMotdSetErrorMessage;
         _messagesTypes[9331] = AllianceBulletinMessage;
         _messagesTypes[4619] = AllianceBulletinSetErrorMessage;
         _messagesTypes[7414] = TaxCollectorErrorMessage;
         _messagesTypes[4949] = TopTaxCollectorListMessage;
         _messagesTypes[6245] = TaxCollectorStateUpdateMessage;
         _messagesTypes[2556] = TaxCollectorAddedMessage;
         _messagesTypes[5818] = TaxCollectorRemovedMessage;
         _messagesTypes[2392] = TaxCollectorAttackedMessage;
         _messagesTypes[5228] = TaxCollectorAttackedResultMessage;
         _messagesTypes[8743] = TaxCollectorHarvestedMessage;
         _messagesTypes[6613] = TaxCollectorMovementsOfflineMessage;
         _messagesTypes[3092] = TaxCollectorEquipmentUpdateMessage;
         _messagesTypes[747] = ConfirmationOfListeningTaxCollectorUpdatesMessage;
         _messagesTypes[7144] = TaxCollectorOrderedSpellUpdatedMessage;
         _messagesTypes[2255] = TaxCollectorPresetsMessage;
         _messagesTypes[4010] = TaxCollectorPresetSpellUpdatedMessage;
         _messagesTypes[4713] = RecruitmentInformationMessage;
         _messagesTypes[4539] = GuildRecruitmentInvalidateMessage;
         _messagesTypes[3426] = GuildApplicationDeletedMessage;
         _messagesTypes[1043] = GuildPlayerApplicationAbstractMessage;
         _messagesTypes[7766] = GuildPlayerApplicationInformationMessage;
         _messagesTypes[5583] = GuildPlayerNoApplicationInformationMessage;
         _messagesTypes[668] = GuildApplicationIsAnsweredMessage;
         _messagesTypes[8273] = GuildListApplicationAnswerMessage;
         _messagesTypes[9601] = GuildListApplicationModifiedMessage;
         _messagesTypes[1062] = GuildApplicationReceivedMessage;
         _messagesTypes[3724] = GuildApplicationPresenceMessage;
         _messagesTypes[1131] = ListenersOfSynchronizedStorageMessage;
         _messagesTypes[4168] = AddListenerOnSynchronizedStorageMessage;
         _messagesTypes[8096] = RemoveListenerOnSynchronizedStorageMessage;
         _messagesTypes[1417] = PrismsListMessage;
         _messagesTypes[4032] = PrismAddOrUpdateMessage;
         _messagesTypes[8129] = PrismRemoveMessage;
         _messagesTypes[6675] = ChallengeFightJoinRefusedMessage;
         _messagesTypes[9353] = PrismAttackedMessage;
         _messagesTypes[3335] = PrismAttackResultMessage;
         _messagesTypes[1617] = NuggetsInformationMessage;
         _messagesTypes[3230] = QuestListMessage;
         _messagesTypes[7772] = QuestStartedMessage;
         _messagesTypes[2202] = QuestValidatedMessage;
         _messagesTypes[1992] = QuestObjectiveValidatedMessage;
         _messagesTypes[7523] = QuestStepValidatedMessage;
         _messagesTypes[7806] = QuestStepStartedMessage;
         _messagesTypes[4967] = QuestStepInfoMessage;
         _messagesTypes[4533] = FollowedQuestsMessage;
         _messagesTypes[1438] = WatchQuestStepInfoMessage;
         _messagesTypes[1180] = WatchQuestListMessage;
         _messagesTypes[7372] = NotificationListMessage;
         _messagesTypes[5888] = NotificationByServerMessage;
         _messagesTypes[1484] = SubscriptionLimitationMessage;
         _messagesTypes[2783] = SubscriptionZoneMessage;
         _messagesTypes[8565] = GuestLimitationMessage;
         _messagesTypes[1505] = GuestModeMessage;
         _messagesTypes[3678] = ListMapNpcsQuestStatusUpdateMessage;
         _messagesTypes[7955] = NpcGenericActionFailureMessage;
         _messagesTypes[8505] = PortalDialogCreationMessage;
         _messagesTypes[5741] = NpcDialogCreationMessage;
         _messagesTypes[941] = NpcDialogQuestionMessage;
         _messagesTypes[9393] = TaxCollectorDialogQuestionBasicMessage;
         _messagesTypes[8895] = TaxCollectorDialogQuestionExtendedMessage;
         _messagesTypes[3736] = AlliancePrismDialogQuestionMessage;
         _messagesTypes[1384] = EntityTalkMessage;
         _messagesTypes[3482] = JobDescriptionMessage;
         _messagesTypes[2061] = JobLevelUpMessage;
         _messagesTypes[1449] = JobExperienceMultiUpdateMessage;
         _messagesTypes[4823] = JobExperienceUpdateMessage;
         _messagesTypes[6590] = JobExperienceOtherPlayerUpdateMessage;
         _messagesTypes[7765] = JobAllowMultiCraftRequestMessage;
         _messagesTypes[9202] = JobMultiCraftAvailableSkillsMessage;
         _messagesTypes[5366] = JobCrafterDirectoryListMessage;
         _messagesTypes[809] = JobCrafterDirectorySettingsMessage;
         _messagesTypes[8232] = JobBookSubscriptionMessage;
         _messagesTypes[6391] = JobCrafterDirectoryRemoveMessage;
         _messagesTypes[2415] = JobCrafterDirectoryAddMessage;
         _messagesTypes[4972] = JobCrafterDirectoryEntryMessage;
         _messagesTypes[7533] = KamasUpdateMessage;
         _messagesTypes[4483] = ObjectGroundAddedMessage;
         _messagesTypes[8803] = ObjectGroundListAddedMessage;
         _messagesTypes[4264] = ObjectGroundRemovedMessage;
         _messagesTypes[1096] = ObjectGroundRemovedMultipleMessage;
         _messagesTypes[6852] = InventoryContentMessage;
         _messagesTypes[9963] = WatchInventoryContentMessage;
         _messagesTypes[4852] = ShortcutBarContentMessage;
         _messagesTypes[5008] = ShortcutBarAddErrorMessage;
         _messagesTypes[3677] = ShortcutBarRemoveErrorMessage;
         _messagesTypes[6665] = ShortcutBarSwapErrorMessage;
         _messagesTypes[5855] = ShortcutBarRefreshMessage;
         _messagesTypes[2604] = ShortcutBarRemovedMessage;
         _messagesTypes[8225] = ShortcutBarReplacedMessage;
         _messagesTypes[1638] = MultiTabStorageMessage;
         _messagesTypes[714] = StorageInventoryContentMessage;
         _messagesTypes[1813] = StorageKamasUpdateMessage;
         _messagesTypes[1698] = StorageObjectUpdateMessage;
         _messagesTypes[131] = StorageObjectsUpdateMessage;
         _messagesTypes[7366] = StorageObjectRemoveMessage;
         _messagesTypes[353] = StorageObjectsRemoveMessage;
         _messagesTypes[2262] = SetUpdateMessage;
         _messagesTypes[1264] = InventoryWeightMessage;
         _messagesTypes[8402] = ObjectMovementMessage;
         _messagesTypes[1715] = ObjectAddedMessage;
         _messagesTypes[8140] = ObjectsAddedMessage;
         _messagesTypes[6571] = GoldAddedMessage;
         _messagesTypes[9812] = ObjectErrorMessage;
         _messagesTypes[1653] = ObjectDeletedMessage;
         _messagesTypes[8636] = ObjectsDeletedMessage;
         _messagesTypes[5076] = ObjectQuantityMessage;
         _messagesTypes[8051] = ObjectsQuantityMessage;
         _messagesTypes[8809] = ObjectModifiedMessage;
         _messagesTypes[5289] = ObjectJobAddedMessage;
         _messagesTypes[7458] = ObtainedItemMessage;
         _messagesTypes[4086] = ObtainedItemWithBonusMessage;
         _messagesTypes[1590] = LivingObjectMessageMessage;
         _messagesTypes[6262] = SymbioticObjectErrorMessage;
         _messagesTypes[7359] = SymbioticObjectAssociatedMessage;
         _messagesTypes[6247] = WrapperObjectErrorMessage;
         _messagesTypes[2742] = WrapperObjectAssociatedMessage;
         _messagesTypes[5947] = MimicryObjectPreviewMessage;
         _messagesTypes[3829] = MimicryObjectErrorMessage;
         _messagesTypes[5494] = MimicryObjectAssociatedMessage;
         _messagesTypes[157] = InvalidPresetsMessage;
         _messagesTypes[3085] = PresetsMessage;
         _messagesTypes[4582] = ItemForPresetUpdateMessage;
         _messagesTypes[8026] = PresetSavedMessage;
         _messagesTypes[1811] = PresetSaveErrorMessage;
         _messagesTypes[9146] = PresetDeleteResultMessage;
         _messagesTypes[1130] = PresetUseResultMessage;
         _messagesTypes[6499] = PresetUseResultWithMissingIdsMessage;
         _messagesTypes[2922] = ExchangeMoneyMovementInformationMessage;
         _messagesTypes[5488] = ExchangeCraftCountModifiedMessage;
         _messagesTypes[3929] = ExchangeObjectMessage;
         _messagesTypes[5600] = ExchangeObjectAddedMessage;
         _messagesTypes[697] = ExchangeObjectsAddedMessage;
         _messagesTypes[5047] = ExchangeObjectRemovedMessage;
         _messagesTypes[5784] = ExchangeObjectsRemovedMessage;
         _messagesTypes[1595] = ExchangeObjectModifiedMessage;
         _messagesTypes[1269] = ExchangeObjectsModifiedMessage;
         _messagesTypes[9199] = ExchangeObjectPutInBagMessage;
         _messagesTypes[5737] = ExchangeObjectRemovedFromBagMessage;
         _messagesTypes[645] = ExchangeObjectModifiedInBagMessage;
         _messagesTypes[9427] = ExchangeKamaModifiedMessage;
         _messagesTypes[2811] = ExchangePodsModifiedMessage;
         _messagesTypes[5453] = ExchangeMultiCraftCrafterCanUseHisRessourcesMessage;
         _messagesTypes[1795] = ExchangeRequestedMessage;
         _messagesTypes[9042] = ExchangeRequestedTradeMessage;
         _messagesTypes[3035] = ExchangeStartedMessage;
         _messagesTypes[3610] = ExchangeStartedWithPodsMessage;
         _messagesTypes[5381] = ExchangeStartedWithStorageMessage;
         _messagesTypes[4550] = ExchangeStartedWithMultiTabStorageMessage;
         _messagesTypes[8142] = ExchangeBidHouseBuyResultMessage;
         _messagesTypes[7397] = ExchangeBidHouseItemAddOkMessage;
         _messagesTypes[7624] = ExchangeBidHouseItemRemoveOkMessage;
         _messagesTypes[8408] = ExchangeBidHouseGenericItemAddedMessage;
         _messagesTypes[7183] = ExchangeBidHouseGenericItemRemovedMessage;
         _messagesTypes[3206] = ExchangeBidHouseInListAddedMessage;
         _messagesTypes[6353] = ExchangeBidHouseInListUpdatedMessage;
         _messagesTypes[2116] = ExchangeBidHouseInListRemovedMessage;
         _messagesTypes[7999] = ExchangeBidHouseUnsoldItemsMessage;
         _messagesTypes[1921] = ExchangeOfflineSoldItemsMessage;
         _messagesTypes[5657] = ExchangeIsReadyMessage;
         _messagesTypes[9130] = ExchangeStoppedMessage;
         _messagesTypes[2983] = ExchangeErrorMessage;
         _messagesTypes[4632] = ExchangeLeaveMessage;
         _messagesTypes[2274] = DecraftResultMessage;
         _messagesTypes[3203] = RecycleResultMessage;
         _messagesTypes[114] = ExchangeStartOkNpcTradeMessage;
         _messagesTypes[5434] = ExchangeStartOkRunesTradeMessage;
         _messagesTypes[441] = ExchangeStartOkEvolutiveObjectRecycleTradeMessage;
         _messagesTypes[3308] = EvolutiveObjectRecycleResultMessage;
         _messagesTypes[9697] = ExchangeStartOkRecycleTradeMessage;
         _messagesTypes[9513] = ExchangeStartOkNpcShopMessage;
         _messagesTypes[3063] = ExchangeOkMultiCraftMessage;
         _messagesTypes[7242] = ExchangeCraftResultMessage;
         _messagesTypes[7330] = ExchangeCraftResultWithObjectIdMessage;
         _messagesTypes[4589] = ExchangeCraftResultWithObjectDescMessage;
         _messagesTypes[8941] = ExchangeCraftResultMagicWithObjectDescMessage;
         _messagesTypes[4793] = ExchangeStartedMountStockMessage;
         _messagesTypes[8727] = ExchangeStartedTaxCollectorShopMessage;
         _messagesTypes[3181] = ExchangeStartedBidSellerMessage;
         _messagesTypes[69] = ExchangeStartedBidBuyerMessage;
         _messagesTypes[167] = ExchangeBidPriceMessage;
         _messagesTypes[2431] = ExchangeBidPriceForSellerMessage;
         _messagesTypes[4903] = ExchangeTypesExchangerDescriptionForUserMessage;
         _messagesTypes[6222] = ExchangeTypesItemsExchangerDescriptionForUserMessage;
         _messagesTypes[2692] = ExchangeWeightMessage;
         _messagesTypes[8075] = ExchangeTaxCollectorGetMessage;
         _messagesTypes[6190] = ItemNoMoreAvailableMessage;
         _messagesTypes[3668] = ExchangeBuyOkMessage;
         _messagesTypes[4089] = ExchangeSellOkMessage;
         _messagesTypes[7760] = ExchangeWaitingResultMessage;
         _messagesTypes[2045] = ExchangeStartOkMountWithOutPaddockMessage;
         _messagesTypes[70] = ExchangeStartOkMountMessage;
         _messagesTypes[3622] = ExchangeMountStableErrorMessage;
         _messagesTypes[5301] = ExchangeMountsStableAddMessage;
         _messagesTypes[7213] = ExchangeMountsPaddockAddMessage;
         _messagesTypes[2906] = ExchangeMountsStableBornAddMessage;
         _messagesTypes[4811] = ExchangeMountsStableRemoveMessage;
         _messagesTypes[216] = ExchangeMountsPaddockRemoveMessage;
         _messagesTypes[5118] = ExchangeMountsTakenFromPaddockMessage;
         _messagesTypes[4133] = ExchangeMountFreeFromPaddockMessage;
         _messagesTypes[815] = ExchangeMountSterilizeFromPaddockMessage;
         _messagesTypes[6551] = ExchangeBidSearchOkMessage;
         _messagesTypes[1129] = ExchangeItemAutoCraftStopedMessage;
         _messagesTypes[9039] = ExchangeStartOkCraftMessage;
         _messagesTypes[187] = ExchangeStartOkCraftWithInformationMessage;
         _messagesTypes[9285] = ExchangeStartOkMulticraftCrafterMessage;
         _messagesTypes[4423] = ExchangeStartOkMulticraftCustomerMessage;
         _messagesTypes[7353] = ExchangeCrafterJobLevelupMessage;
         _messagesTypes[9517] = ExchangeStartOkJobIndexMessage;
         _messagesTypes[6612] = ExchangeCraftPaymentModifiedMessage;
         _messagesTypes[8598] = UpdateMountCharacteristicsMessage;
         _messagesTypes[309] = ExchangeStartedTaxCollectorEquipmentMessage;
         _messagesTypes[7217] = ObjectAveragePricesErrorMessage;
         _messagesTypes[5500] = ObjectAveragePricesMessage;
         _messagesTypes[6161] = PurchasableDialogMessage;
         _messagesTypes[9333] = AccountHouseMessage;
         _messagesTypes[9986] = HousePropertiesMessage;
         _messagesTypes[4028] = HouseBuyResultMessage;
         _messagesTypes[7266] = HouseSellingUpdateMessage;
         _messagesTypes[5156] = HouseToSellListMessage;
         _messagesTypes[1896] = HouseGuildNoneMessage;
         _messagesTypes[9687] = HouseGuildRightsMessage;
         _messagesTypes[8746] = PaddockBuyResultMessage;
         _messagesTypes[3466] = PaddockPropertiesMessage;
         _messagesTypes[8366] = PaddockSellBuyDialogMessage;
         _messagesTypes[8020] = GameDataPlayFarmObjectAnimationMessage;
         _messagesTypes[150] = PaddockToSellListMessage;
         _messagesTypes[2501] = HavenBagRoomUpdateMessage;
         _messagesTypes[5094] = HavenBagPackListMessage;
         _messagesTypes[6218] = EditHavenBagStartMessage;
         _messagesTypes[7607] = EditHavenBagFinishedMessage;
         _messagesTypes[3125] = HavenBagDailyLoteryMessage;
         _messagesTypes[8105] = HavenBagFurnituresMessage;
         _messagesTypes[6334] = MapComplementaryInformationsDataInHavenBagMessage;
         _messagesTypes[6625] = HavenBagPermissionsUpdateMessage;
         _messagesTypes[2168] = InviteInHavenBagClosedMessage;
         _messagesTypes[5865] = InviteInHavenBagMessage;
         _messagesTypes[6664] = InviteInHavenBagOfferMessage;
         _messagesTypes[2864] = MountSterilizedMessage;
         _messagesTypes[5629] = MountReleasedMessage;
         _messagesTypes[2193] = MountRenamedMessage;
         _messagesTypes[9013] = MountXpRatioMessage;
         _messagesTypes[2845] = MountDataMessage;
         _messagesTypes[4561] = MountDataErrorMessage;
         _messagesTypes[1821] = MountSetMessage;
         _messagesTypes[3117] = MountUnSetMessage;
         _messagesTypes[1703] = MountEquipedErrorMessage;
         _messagesTypes[6377] = MountRidingMessage;
         _messagesTypes[4336] = GameDataPaddockObjectRemoveMessage;
         _messagesTypes[8777] = GameDataPaddockObjectAddMessage;
         _messagesTypes[2838] = GameDataPaddockObjectListAddMessage;
         _messagesTypes[2401] = MountEmoteIconUsedOkMessage;
         _messagesTypes[828] = LockableShowCodeDialogMessage;
         _messagesTypes[5928] = LockableCodeResultMessage;
         _messagesTypes[4415] = LockableStateUpdateAbstractMessage;
         _messagesTypes[7591] = LockableStateUpdateHouseDoorMessage;
         _messagesTypes[195] = LockableStateUpdateStorageMessage;
         _messagesTypes[9177] = DocumentReadingBeginMessage;
         _messagesTypes[6845] = OpenGuideBookMessage;
         _messagesTypes[4737] = TitlesAndOrnamentsListMessage;
         _messagesTypes[3189] = TitleGainedMessage;
         _messagesTypes[9893] = TitleLostMessage;
         _messagesTypes[3437] = OrnamentGainedMessage;
         _messagesTypes[4328] = OrnamentLostMessage;
         _messagesTypes[2229] = TitleSelectedMessage;
         _messagesTypes[9939] = TitleSelectErrorMessage;
         _messagesTypes[50] = OrnamentSelectedMessage;
         _messagesTypes[9925] = OrnamentSelectErrorMessage;
         _messagesTypes[6294] = ContactLookMessage;
         _messagesTypes[3083] = ContactLookErrorMessage;
         _messagesTypes[1872] = SocialNoticeMessage;
         _messagesTypes[2161] = BulletinMessage;
         _messagesTypes[4315] = SocialNoticeSetErrorMessage;
         _messagesTypes[4266] = AccessoryPreviewErrorMessage;
         _messagesTypes[3698] = AccessoryPreviewMessage;
         _messagesTypes[5004] = HaapiBufferListMessage;
         _messagesTypes[5342] = HaapiConfirmationMessage;
         _messagesTypes[4420] = HaapiValidationMessage;
         _messagesTypes[9053] = HaapiBuyValidationMessage;
         _messagesTypes[8414] = HaapiApiKeyMessage;
         _messagesTypes[996] = HaapiShopApiKeyMessage;
         _messagesTypes[4627] = FinishMoveListMessage;
         _messagesTypes[4090] = TreasureHuntShowLegendaryUIMessage;
         _messagesTypes[1124] = TreasureHuntRequestAnswerMessage;
         _messagesTypes[8631] = TreasureHuntMessage;
         _messagesTypes[5011] = TreasureHuntFinishedMessage;
         _messagesTypes[9605] = TreasureHuntDigRequestAnswerMessage;
         _messagesTypes[9092] = TreasureHuntDigRequestAnswerFailedMessage;
         _messagesTypes[8537] = TreasureHuntFlagRequestAnswerMessage;
         _messagesTypes[3343] = TreasureHuntAvailableRetryCountUpdateMessage;
         _messagesTypes[7310] = BreachStateMessage;
         _messagesTypes[7809] = BreachCharactersMessage;
         _messagesTypes[1156] = BreachBonusMessage;
         _messagesTypes[5730] = BreachBudgetMessage;
         _messagesTypes[9736] = BreachSavedMessage;
         _messagesTypes[1483] = BreachBranchesMessage;
         _messagesTypes[8452] = BreachRewardsMessage;
         _messagesTypes[4385] = BreachRewardBoughtMessage;
         _messagesTypes[5823] = BreachInvitationOfferMessage;
         _messagesTypes[6364] = BreachInvitationResponseMessage;
         _messagesTypes[7276] = BreachInvitationCloseMessage;
         _messagesTypes[8936] = BreachKickResponseMessage;
         _messagesTypes[4331] = AnomalySubareaInformationResponseMessage;
         _messagesTypes[9673] = AlignmentWarEffortProgressionMessage;
         _messagesTypes[7746] = CharacterAlignmentWarEffortProgressionMessage;
         _messagesTypes[8641] = AlignmentWarEffortDonatePreviewMessage;
         _messagesTypes[7971] = AlignmentWarEffortDonationResultMessage;
         _messagesTypes[438] = HaapiTokenMessage;
         _messagesTypes[3241] = HaapiAuthErrorMessage;
         _messagesTypes[925] = HaapiSessionMessage;
         _messagesTypes[7589] = DebtsUpdateMessage;
         _messagesTypes[403] = DebtsDeleteMessage;
         _messagesTypes[1245] = ActivitySuggestionsMessage;
         _messagesTypes[6448] = AlterationsMessage;
         _messagesTypes[2682] = AlterationAddedMessage;
         _messagesTypes[9621] = AlterationRemovedMessage;
         _messagesTypes[1928] = AlterationsUpdatedMessage;
         _unpackModes[4506] = UnpackMode.ASYNC;
      }
