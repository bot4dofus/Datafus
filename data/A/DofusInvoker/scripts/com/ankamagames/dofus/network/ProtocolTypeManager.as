package com.ankamagames.dofus.network
{
   ...
   public class ProtocolTypeManager
   {
      ...
      {
         _typesTypes[2452] = CharacterBaseInformations;
         _typesTypes[2513] = PartyMemberInformations;
         _typesTypes[9523] = PartyMemberArenaInformations;
         _typesTypes[4042] = PartyInvitationMemberInformations;
         _typesTypes[6564] = CharacterHardcoreOrEpicInformations;
         _typesTypes[7698] = EntityDispositionInformations;
         _typesTypes[6387] = IdentifiedEntityDispositionInformations;
         _typesTypes[3778] = FightEntityDispositionInformations;
         _typesTypes[7991] = AbstractSocialGroupInfos;
         _typesTypes[2417] = BasicAllianceInformations;
         _typesTypes[7519] = BasicNamedAllianceInformations;
         _typesTypes[8571] = AllianceInformation;
         _typesTypes[7046] = AllianceFactSheetInformation;
         _typesTypes[1846] = BasicGuildInformations;
         _typesTypes[1926] = GuildInformations;
         _typesTypes[9268] = GuildFactSheetInformations;
         _typesTypes[8059] = GuildInsiderFactSheetInformations;
         _typesTypes[9268] = GuildFactSheetInformations;
         _typesTypes[8059] = GuildInsiderFactSheetInformations;
         _typesTypes[7046] = AllianceFactSheetInformation;
         _typesTypes[7498] = PrismGeolocalizedInformation;
         _typesTypes[1216] = PrismInformation;
         _typesTypes[457] = AlliancePrismInformation;
         _typesTypes[4695] = AllianceInsiderPrismInformation;
         _typesTypes[6940] = CharacterCharacteristic;
         _typesTypes[1617] = CharacterCharacteristicDetailed;
         _typesTypes[5159] = CharacterUsableCharacteristicDetailed;
         _typesTypes[1734] = CharacterCharacteristicValue;
         _typesTypes[1746] = FightTeamMemberInformations;
         _typesTypes[4255] = FightTeamMemberCharacterInformations;
         _typesTypes[1201] = FightTeamMemberWithAllianceCharacterInformations;
         _typesTypes[2351] = FightTeamMemberTaxCollectorInformations;
         _typesTypes[6292] = FightTeamMemberMonsterInformations;
         _typesTypes[3086] = FightTeamMemberEntityInformation;
         _typesTypes[7691] = FightTeamInformations;
         _typesTypes[9458] = FightAllianceTeamInformations;
         _typesTypes[6955] = GameFightCharacteristics;
         _typesTypes[7517] = FightResultListEntry;
         _typesTypes[5422] = FightResultFighterListEntry;
         _typesTypes[9553] = FightResultTaxCollectorListEntry;
         _typesTypes[3279] = FightResultPlayerListEntry;
         _typesTypes[6202] = FightResultMutantListEntry;
         _typesTypes[9960] = FightResultAdditionalData;
         _typesTypes[8052] = FightResultPvpData;
         _typesTypes[8574] = FightResultExperienceData;
         _typesTypes[1756] = AbstractFightDispellableEffect;
         _typesTypes[9696] = FightTemporaryBoostEffect;
         _typesTypes[579] = FightTemporaryBoostStateEffect;
         _typesTypes[8023] = FightTemporarySpellBoostEffect;
         _typesTypes[8844] = FightTemporaryBoostWeaponDamagesEffect;
         _typesTypes[7450] = FightTemporarySpellImmunityEffect;
         _typesTypes[1743] = FightTriggeredEffect;
         _typesTypes[3603] = ObjectEffect;
         _typesTypes[9517] = ObjectEffectInteger;
         _typesTypes[4655] = ObjectEffectCreature;
         _typesTypes[894] = ObjectEffectLadder;
         _typesTypes[1723] = ObjectEffectMinMax;
         _typesTypes[3082] = ObjectEffectDuration;
         _typesTypes[968] = ObjectEffectString;
         _typesTypes[3638] = ObjectEffectDice;
         _typesTypes[3208] = ObjectEffectDate;
         _typesTypes[2560] = ObjectEffectMount;
         _typesTypes[1790] = UpdateMountCharacteristic;
         _typesTypes[5362] = UpdateMountBooleanCharacteristic;
         _typesTypes[2132] = UpdateMountIntegerCharacteristic;
         _typesTypes[227] = Shortcut;
         _typesTypes[4] = ShortcutObject;
         _typesTypes[2112] = ShortcutObjectPreset;
         _typesTypes[7454] = ShortcutObjectIdolsPreset;
         _typesTypes[1305] = ShortcutObjectItem;
         _typesTypes[4319] = ShortcutSpell;
         _typesTypes[1970] = ShortcutSmiley;
         _typesTypes[9428] = ShortcutEmote;
         _typesTypes[8462] = ShortcutEntitiesPreset;
         _typesTypes[194] = Idol;
         _typesTypes[7724] = PartyIdol;
         _typesTypes[7724] = PartyIdol;
         _typesTypes[5069] = AchievementAchieved;
         _typesTypes[6979] = AchievementAchievedRewardable;
         _typesTypes[9764] = IgnoredInformations;
         _typesTypes[6999] = IgnoredOnlineInformations;
         _typesTypes[6964] = FriendInformations;
         _typesTypes[8907] = FriendOnlineInformations;
         _typesTypes[8686] = AcquaintanceInformation;
         _typesTypes[7803] = AcquaintanceOnlineInformation;
         _typesTypes[410] = FriendSpouseInformations;
         _typesTypes[291] = FriendSpouseOnlineInformations;
         _typesTypes[5765] = InteractiveElementSkill;
         _typesTypes[5413] = InteractiveElementNamedSkill;
         _typesTypes[7268] = InteractiveElement;
         _typesTypes[6791] = InteractiveElementWithAgeBonus;
         _typesTypes[2513] = PartyMemberInformations;
         _typesTypes[9523] = PartyMemberArenaInformations;
         _typesTypes[4042] = PartyInvitationMemberInformations;
         _typesTypes[8081] = PartyEntityBaseInformation;
         _typesTypes[6182] = PartyEntityMemberInformation;
         _typesTypes[1618] = SkillActionDescription;
         _typesTypes[2390] = SkillActionDescriptionTimed;
         _typesTypes[9530] = SkillActionDescriptionCollect;
         _typesTypes[8856] = SkillActionDescriptionCraft;
         _typesTypes[3683] = HouseInformations;
         _typesTypes[657] = AccountHouseInformations;
         _typesTypes[5988] = HouseInformationsInside;
         _typesTypes[3231] = HouseInformationsForGuild;
         _typesTypes[1996] = HouseOnMapInformations;
         _typesTypes[3901] = HouseInstanceInformations;
         _typesTypes[7385] = HouseGuildedInformations;
         _typesTypes[2243] = PaddockBuyableInformations;
         _typesTypes[6429] = PaddockGuildedInformations;
         _typesTypes[8964] = GameContextActorPositionInformations;
         _typesTypes[7205] = GameContextActorInformations;
         _typesTypes[5323] = GameFightFighterInformations;
         _typesTypes[6921] = GameFightAIInformations;
         _typesTypes[3979] = GameFightMonsterInformations;
         _typesTypes[5777] = GameFightMonsterWithAlignmentInformations;
         _typesTypes[5115] = GameFightTaxCollectorInformations;
         _typesTypes[7557] = GameFightFighterNamedInformations;
         _typesTypes[3849] = GameFightCharacterInformations;
         _typesTypes[4450] = GameFightMutantInformations;
         _typesTypes[9832] = GameFightEntityInformation;
         _typesTypes[7524] = GameRolePlayActorInformations;
         _typesTypes[9495] = GameRolePlayNamedActorInformations;
         _typesTypes[3271] = GameRolePlayHumanoidInformations;
         _typesTypes[181] = GameRolePlayMutantInformations;
         _typesTypes[7660] = GameRolePlayCharacterInformations;
         _typesTypes[2389] = GameRolePlayMountInformations;
         _typesTypes[1045] = GameRolePlayNpcInformations;
         _typesTypes[1620] = GameRolePlayNpcWithQuestInformations;
         _typesTypes[1792] = GameRolePlayGroupMonsterInformations;
         _typesTypes[13] = GameRolePlayGroupMonsterWaveInformations;
         _typesTypes[8648] = GameRolePlayTreasureHintInformations;
         _typesTypes[7243] = GameRolePlayTaxCollectorInformations;
         _typesTypes[1179] = GameRolePlayPrismInformations;
         _typesTypes[1979] = GameRolePlayPortalInformations;
         _typesTypes[7205] = GameContextActorInformations;
         _typesTypes[5323] = GameFightFighterInformations;
         _typesTypes[6921] = GameFightAIInformations;
         _typesTypes[3979] = GameFightMonsterInformations;
         ...
         _typesTypes[1179] = GameRolePlayPrismInformations;
         _typesTypes[1979] = GameRolePlayPortalInformations;
         _typesTypes[6386] = HumanInformations;
         _typesTypes[2230] = HumanOption;
         _typesTypes[3788] = HumanOptionObjectUse;
         _typesTypes[5763] = HumanOptionAlliance;
         _typesTypes[5112] = HumanOptionGuild;
         _typesTypes[698] = HumanOptionOrnament;
         _typesTypes[4646] = HumanOptionEmote;
         _typesTypes[6435] = HumanOptionTitle;
         _typesTypes[5451] = HumanOptionSkillUse;
         _typesTypes[6226] = HumanOptionSpeedMultiplier;
         _typesTypes[1140] = HumanOptionFollowers;
         _typesTypes[8725] = TaxCollectorStaticInformations;
         _typesTypes[5297] = TaxCollectorInformations;
         _typesTypes[6804] = TaxCollectorComplementaryInformations;
         _typesTypes[9158] = TaxCollectorLootInformations;
         _typesTypes[7593] = TaxCollectorWaitingForHelpInformations;
         _typesTypes[8171] = GroupMonsterStaticInformations;
         _typesTypes[190] = GroupMonsterStaticInformationsWithAlternatives;
         _typesTypes[3238] = QuestActiveInformations;
         _typesTypes[6798] = QuestActiveDetailedInformations;
         _typesTypes[2010] = QuestObjectiveInformations;
         _typesTypes[779] = QuestObjectiveInformationsWithCompletion;
         _typesTypes[5168] = SpawnInformation;
         _typesTypes[6653] = BaseSpawnMonsterInformation;
         _typesTypes[6576] = SpawnScaledMonsterInformation;
         _typesTypes[3335] = SpawnMonsterInformation;
         _typesTypes[3098] = SpawnCharacterInformation;
         _typesTypes[1659] = SpawnCompanionInformation;
         _typesTypes[515] = GameContextBasicSpawnInformation;
         _typesTypes[6365] = GameContextSummonsInformation;
         _typesTypes[5323] = GameFightFighterInformations;
         _typesTypes[6921] = GameFightAIInformations;
         _typesTypes[3979] = GameFightMonsterInformations;
         _typesTypes[5777] = GameFightMonsterWithAlignmentInformations;
         ...
         _typesTypes[4450] = GameFightMutantInformations;
         _typesTypes[9832] = GameFightEntityInformation;
         _typesTypes[3501] = GameFightFighterLightInformations;
         _typesTypes[6154] = GameFightFighterMonsterLightInformations;
         _typesTypes[5392] = GameFightFighterNamedLightInformations;
         _typesTypes[5322] = GameFightFighterTaxCollectorLightInformations;
         _typesTypes[73] = GameFightFighterEntityLightInformation;
         _typesTypes[2055] = MapCoordinates;
         _typesTypes[586] = MapCoordinatesAndId;
         _typesTypes[3078] = MapCoordinatesExtended;
         _typesTypes[9272] = Preset;
         _typesTypes[7787] = PresetsContainerPreset;
         _typesTypes[9494] = IconNamedPreset;
         _typesTypes[8875] = SpellsPreset;
         _typesTypes[776] = ForgettableSpellsPreset;
         _typesTypes[3542] = StatsPreset;
         _typesTypes[3601] = IdolsPreset;
         _typesTypes[2902] = EntitiesPreset;
         _typesTypes[5543] = FullStatsPreset;
         _typesTypes[8802] = ItemsPreset;
         _typesTypes[8293] = TreasureHuntStep;
         _typesTypes[5886] = TreasureHuntStepFollowDirectionToPOI;
         _typesTypes[2876] = TreasureHuntStepDig;
         _typesTypes[4583] = TreasureHuntStepFight;
         _typesTypes[681] = TreasureHuntStepFollowDirectionToHint;
         _typesTypes[240] = TreasureHuntStepFollowDirection;
         _typesTypes[3939] = AbstractPlayerSearchInformation;
         _typesTypes[7174] = PlayerSearchTagInformation;
         _typesTypes[4623] = PlayerSearchCharacterNameInformation;
         _typesTypes[1920] = PortalInformation;
         _typesTypes[9839] = BreachBranch;
         _typesTypes[8184] = ExtendedBreachBranch;
         _typesTypes[7470] = ExtendedLockedBreachBranch;
         _typesTypes[8184] = ExtendedBreachBranch;
         _typesTypes[7470] = ExtendedLockedBreachBranch;
         _typesTypes[2507] = PlayerStatus;
         _typesTypes[1387] = PlayerStatusExtended;
         _typesTypes[5153] = ServerSessionConstant;
         _typesTypes[2522] = ServerSessionConstantString;
         _typesTypes[906] = ServerSessionConstantInteger;
         _typesTypes[140] = ServerSessionConstantLong;
         _typesTypes[2122] = StatisticData;
         _typesTypes[9448] = StatisticDataInt;
         _typesTypes[5986] = StatisticDataBoolean;
         _typesTypes[8835] = StatisticDataShort;
         _typesTypes[6562] = StatisticDataString;
         _typesTypes[6559] = StatisticDataByte;
         _typesTypes[8813] = DebtInformation;
         _typesTypes[4408] = KamaDebtInformation;
         _typesTypes[8984] = GuildLogbookEntryBasicInformation;
         _typesTypes[464] = GuildRankActivity;
         _typesTypes[5072] = GuildPlayerRankUpdateActivity;
         _typesTypes[3655] = GuildLogbookChestActivity;
         _typesTypes[2955] = GuildLevelUpActivity;
         _typesTypes[5969] = GuildPaddockActivity;
         _typesTypes[9410] = GuildPlayerFlowActivity;
         _typesTypes[690] = GuildUnlockNewTabActivity;
      }
