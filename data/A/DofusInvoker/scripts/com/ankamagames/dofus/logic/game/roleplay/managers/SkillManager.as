package com.ankamagames.dofus.logic.game.roleplay.managers
{
   ...
   public class SkillManager
   {
      ...
      private function showInteractiveElementNotification(jobName:String, skillLevelMin:int, currentJobLevel:int) : void
      {
         ...
         var nid:uint = NotificationManager.getInstance().prepareNotification(I18n.getUiText("ui.skill.impossibleGathering"),text,NotificationTypeEnum.JOB_INFORMATION,"interactiveElementDisabled");
