...
{
   public class DetailedPresetStat extends PresetStat
   {
      ...
      public function DetailedPresetStat(id:Number, baseValue:Number, additionalValue:Number, objectsAndMountBonusValue:Number, alignGiftBonusValue:Number, contextModifValue:Number)
      {
