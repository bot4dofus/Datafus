package com.ankamagames.dofus.internalDatacenter.people
{
   ...
   public class SocialApplicationPlayerDataWrapper
   {
      ...
      public function SocialApplicationPlayerDataWrapper(playerId:Number = 0, playerName:String = null, breed:int = 0, sex:Boolean = false, level:uint = 0, accountId:uint = 0, accountTag:String = null, accountName:String = null, statusId:uint = 0, statusMessage:String = null)
      {
         super();
      ...
      public static function wrap(info:ApplicationPlayerInformation) : SocialApplicationPlayerDataWrapper
      {
         return new SocialApplicationPlayerDataWrapper(info.playerId,info.playerName,info.breed,info.sex,info.level,info.accountId,info.accountTag,info.accountNickname,info.status.statusId,info.status is PlayerStatusExtended ? (info.status as PlayerStatusExtended).message : null);
      }
