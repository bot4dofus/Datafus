...
{
   public class UsablePresetStat extends DetailedPresetStat
   {
       
      
      public var usedValue:Number = 0;
      
      public function UsablePresetStat(id:Number, baseValue:Number, additionalValue:Number, objectsAndMountBonusValue:Number, alignGiftBonusValue:Number, contextModifValue:Number, usedValue:Number)
      {
