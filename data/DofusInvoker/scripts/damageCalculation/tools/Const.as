package damageCalculation.tools
{
   public class Const
   {
      ...
      public static var ACTION_TYPE_MISC:int = 0;
      
      public static var ACTION_TYPE_RESISTANCE:int = 1;
      
      public static var ACTION_TYPE_DAMAGE:int = 2;
      
      public static var ACTION_TYPE_SPELL_BOOST:int = 3;
      
      public static var ACTION_TYPE_STATE:int = 4;
      ...
      public static var LIFE_POINTS:String = "baseMaxLifePoints";
      ...
      public static var MAX_SUMMONED_CREATURES_BOOST:String = "summonableCreaturesBoost";
      ...
      public static var MAGIC_FIND:String = "prospecting";
      ...
      public static var MAX_ENERGY_POINTS:String = "maxEnergyPoints";
      ...
      public static var PERMANENT_DAMAGE_PERCENT:String = "permanentDamagePercent";
      ...
      public static var STRENGTH_INITIAL_PERCENT:String = "strengthInitialPercent";
      
      public static var VITALITY_INITIAL_PERCENT:String = "vitalityInitialPercent";
      
      public static var WISDOM_INITIAL_PERCENT:String = "wisdomInitialPercent";
      
      public static var CHANCE_INITIAL_PERCENT:String = "chanceInitialPercent";
      
      public static var AGILITY_INITIAL_PERCENT:String = "agilityInitialPercent";
      
      public static var INTELLIGENCE_INITIAL_PERCENT:String = "intelligenceInitialPercent";
      
      public static var TACKLE_EVADE_INITIAL_PERCENT:String = "tackleEvadeInitialPercent";
      
      public static var TACKLE_BLOCK_INITIAL_PERCENT:String = "tackleBlockInitialPercent";
      
      public static var ACTION_POINTS_INITIAL_PERCENT:String = "actionPointsInitialPercent";
      
      public static var MOVEMENT_POINTS_INITIAL_PERCENT:String = "movementPointsInitialPercent";
      
      public static var AP_ATTACK_INITIAL_PERCENT:String = "PAAttackInitialPercent";
      
      public static var MP_ATTACK_INITIAL_PERCENT:String = "PMAttackInitialPercent";
      
      public static var DODGE_PA_LOST_PROBABILITY_INITIAL_PERCENT:String = "dodgePALostProbabilityInitialPercent";
      
      public static var DODGE_PM_LOST_PROBABILITY_INITIAL_PERCENT:String = "dodgePMLostProbabilityInitialPercent";
      
      public static var MOCK_INFO_ALLY:String = "Ally";
      
      public static var MOCK_INFO_BREED_BE_CARRIED:String = "breedBeCarried";
      
      public static var MOCK_INFO_BREED_BE_PUSHED:String = "breedBePushed";
      
      public static var MOCK_INFO_BREED_SWITCH_POS:String = "breedSwitchPos";
      
      public static var MOCK_INFO_BREED_SWITCH_POS_ON_TARGET:String = "breedSwitchPosOnTarget";
      
      public static var MOCK_INFO_BREED_USE_PORTALS:String = "breedUsePortals";
      
      public static var MOCK_INFO_CARRIED:String = "Carried";
      
      public static var MOCK_INFO_DODGE:String = "dodge";
      
      public static var MOCK_INFO_HUMAN:String = "Human";
      
      public static var MOCK_INFO_IS_INVISIBLE:String = "isInvisible";
      
      public static var MOCK_INFO_IS_STATIC:String = "isStatic";
      
      public static var MOCK_INFO_IS_SUMMON_CONTROLLABLE:String = "isSummonControllable";
      
      public static var MOCK_INFO_IS_SUMMONED:String = "isSummoned";
      
      public static var MOCK_INFO_NEED_SUMMON_SLOT:String = "needSummonSlot";
      
      public static var MOCK_INFO_SIDEKICK:String = "Sidekick";
      
      public static var MOCK_INFO_TEAM_ID:String = "TeamId";
