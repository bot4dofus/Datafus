package com.ankamagames.dofus.network
{
   ...
   public class ProtocolTypeManager
   {
      ...
      {
         _typesTypes[5553] = CharacterMinimalPlusLookInformations;
         _typesTypes[5241] = CharacterBaseInformations;
         _typesTypes[2562] = PartyMemberInformations;
         _typesTypes[7745] = PartyMemberArenaInformations;
         _typesTypes[1462] = PartyInvitationMemberInformations;
         _typesTypes[4055] = CharacterHardcoreOrEpicInformations;
         _typesTypes[6596] = CharacterMinimalGuildInformations;
         _typesTypes[3044] = CharacterMinimalAllianceInformations;
         _typesTypes[1566] = CharacterMinimalPlusLookAndGradeInformations;
         _typesTypes[5241] = CharacterBaseInformations;
         _typesTypes[2562] = PartyMemberInformations;
         _typesTypes[7745] = PartyMemberArenaInformations;
         _typesTypes[1462] = PartyInvitationMemberInformations;
         _typesTypes[4055] = CharacterHardcoreOrEpicInformations;
         _typesTypes[4639] = EntityDispositionInformations;
         _typesTypes[4115] = IdentifiedEntityDispositionInformations;
         _typesTypes[1045] = FightEntityDispositionInformations;
         _typesTypes[7197] = AbstractSocialGroupInfos;
         _typesTypes[9708] = BasicGuildInformations;
         _typesTypes[9043] = GuildInformations;
         _typesTypes[9855] = GuildFactSheetInformations;
         _typesTypes[8297] = GuildInsiderFactSheetInformations;
         _typesTypes[4097] = GuildInAllianceInformations;
         _typesTypes[6222] = AlliancedGuildFactSheetInformations;
         _typesTypes[8784] = BasicAllianceInformations;
         _typesTypes[5831] = BasicNamedAllianceInformations;
         _typesTypes[7721] = AllianceInformations;
         _typesTypes[883] = AllianceFactSheetInformations;
         _typesTypes[2866] = GuildVersatileInformations;
         _typesTypes[7435] = GuildInAllianceVersatileInformations;
         _typesTypes[9855] = GuildFactSheetInformations;
         _typesTypes[8297] = GuildInsiderFactSheetInformations;
         _typesTypes[883] = AllianceFactSheetInformations;
         _typesTypes[323] = PrismSubareaEmptyInfo;
         _typesTypes[8286] = PrismGeolocalizedInformation;
         _typesTypes[7553] = PrismInformation;
         _typesTypes[1085] = AlliancePrismInformation;
         _typesTypes[4596] = AllianceInsiderPrismInformation;
         _typesTypes[1975] = CharacterCharacteristic;
         _typesTypes[4320] = CharacterCharacteristicDetailed;
         _typesTypes[8115] = CharacterUsableCharacteristicDetailed;
         _typesTypes[9] = CharacterCharacteristicValue;
         _typesTypes[4449] = FightTeamMemberInformations;
         _typesTypes[3454] = FightTeamMemberCharacterInformations;
         _typesTypes[3981] = FightTeamMemberWithAllianceCharacterInformations;
         _typesTypes[3317] = FightTeamMemberTaxCollectorInformations;
         _typesTypes[7483] = FightTeamMemberMonsterInformations;
         _typesTypes[3734] = FightTeamMemberEntityInformation;
         _typesTypes[1598] = FightTeamInformations;
         _typesTypes[6485] = FightAllianceTeamInformations;
         _typesTypes[9003] = GameFightCharacteristics;
         _typesTypes[652] = FightResultListEntry;
         _typesTypes[9670] = FightResultFighterListEntry;
         _typesTypes[9330] = FightResultTaxCollectorListEntry;
         _typesTypes[4199] = FightResultPlayerListEntry;
         _typesTypes[2534] = FightResultMutantListEntry;
         _typesTypes[7465] = FightResultAdditionalData;
         _typesTypes[6318] = FightResultPvpData;
         _typesTypes[4352] = FightResultExperienceData;
         _typesTypes[2930] = AbstractFightDispellableEffect;
         _typesTypes[9498] = FightTemporaryBoostEffect;
         _typesTypes[1699] = FightTemporaryBoostStateEffect;
         _typesTypes[2068] = FightTemporarySpellBoostEffect;
         _typesTypes[320] = FightTemporaryBoostWeaponDamagesEffect;
         _typesTypes[3005] = FightTemporarySpellImmunityEffect;
         _typesTypes[9782] = FightTriggeredEffect;
         _typesTypes[3919] = ObjectEffect;
         _typesTypes[5629] = ObjectEffectInteger;
         _typesTypes[9687] = ObjectEffectCreature;
         _typesTypes[3891] = ObjectEffectLadder;
         _typesTypes[8222] = ObjectEffectMinMax;
         _typesTypes[1728] = ObjectEffectDuration;
         _typesTypes[3289] = ObjectEffectString;
         _typesTypes[7888] = ObjectEffectDice;
         _typesTypes[1929] = ObjectEffectDate;
         _typesTypes[6010] = ObjectEffectMount;
         _typesTypes[3174] = UpdateMountCharacteristic;
         _typesTypes[3282] = UpdateMountBooleanCharacteristic;
         _typesTypes[9909] = UpdateMountIntegerCharacteristic;
         _typesTypes[5639] = Shortcut;
         _typesTypes[6067] = ShortcutObject;
         _typesTypes[7026] = ShortcutObjectPreset;
         _typesTypes[472] = ShortcutObjectIdolsPreset;
         _typesTypes[954] = ShortcutObjectItem;
         _typesTypes[2349] = ShortcutSpell;
         _typesTypes[8390] = ShortcutSmiley;
         _typesTypes[9965] = ShortcutEmote;
         _typesTypes[3958] = ShortcutEntitiesPreset;
         _typesTypes[5898] = Idol;
         _typesTypes[2232] = PartyIdol;
         _typesTypes[2232] = PartyIdol;
         _typesTypes[3784] = AchievementAchieved;
         _typesTypes[3393] = AchievementAchievedRewardable;
         _typesTypes[9376] = IgnoredInformations;
         _typesTypes[911] = IgnoredOnlineInformations;
         _typesTypes[6377] = FriendInformations;
         _typesTypes[9867] = FriendOnlineInformations;
         _typesTypes[8682] = AcquaintanceInformation;
         _typesTypes[7790] = AcquaintanceOnlineInformation;
         _typesTypes[9427] = FriendSpouseInformations;
         _typesTypes[385] = FriendSpouseOnlineInformations;
         _typesTypes[6496] = InteractiveElementSkill;
         _typesTypes[8158] = InteractiveElementNamedSkill;
         _typesTypes[6827] = InteractiveElement;
         _typesTypes[7257] = InteractiveElementWithAgeBonus;
         _typesTypes[2562] = PartyMemberInformations;
         _typesTypes[7745] = PartyMemberArenaInformations;
         _typesTypes[1462] = PartyInvitationMemberInformations;
         _typesTypes[6238] = PartyEntityBaseInformation;
         _typesTypes[2153] = PartyEntityMemberInformation;
         _typesTypes[2974] = SkillActionDescription;
         _typesTypes[8684] = SkillActionDescriptionTimed;
         _typesTypes[4182] = SkillActionDescriptionCollect;
         _typesTypes[8945] = SkillActionDescriptionCraft;
         _typesTypes[8100] = HouseInformations;
         _typesTypes[4255] = AccountHouseInformations;
         _typesTypes[3735] = HouseInformationsInside;
         _typesTypes[6571] = HouseInformationsForGuild;
         _typesTypes[2212] = HouseOnMapInformations;
         _typesTypes[3939] = HouseInstanceInformations;
         _typesTypes[5826] = HouseGuildedInformations;
         _typesTypes[6796] = PaddockBuyableInformations;
         _typesTypes[1561] = PaddockGuildedInformations;
         _typesTypes[5791] = GameContextActorPositionInformations;
         _typesTypes[2731] = GameContextActorInformations;
         _typesTypes[1336] = GameFightFighterInformations;
         _typesTypes[8962] = GameFightAIInformations;
         _typesTypes[7996] = GameFightMonsterInformations;
         _typesTypes[685] = GameFightMonsterWithAlignmentInformations;
         _typesTypes[6160] = GameFightTaxCollectorInformations;
         _typesTypes[2626] = GameFightFighterNamedInformations;
         _typesTypes[5869] = GameFightCharacterInformations;
         _typesTypes[5304] = GameFightMutantInformations;
         _typesTypes[9037] = GameFightEntityInformation;
         _typesTypes[5525] = GameRolePlayActorInformations;
         _typesTypes[6078] = GameRolePlayNamedActorInformations;
         _typesTypes[9573] = GameRolePlayHumanoidInformations;
         _typesTypes[9024] = GameRolePlayMutantInformations;
         _typesTypes[5128] = GameRolePlayCharacterInformations;
         _typesTypes[3397] = GameRolePlayMountInformations;
         _typesTypes[8878] = GameRolePlayMerchantInformations;
         _typesTypes[8667] = GameRolePlayNpcInformations;
         _typesTypes[4530] = GameRolePlayNpcWithQuestInformations;
         _typesTypes[163] = GameRolePlayGroupMonsterInformations;
         _typesTypes[4916] = GameRolePlayGroupMonsterWaveInformations;
         _typesTypes[944] = GameRolePlayTreasureHintInformations;
         _typesTypes[3371] = GameRolePlayTaxCollectorInformations;
         _typesTypes[1935] = GameRolePlayPrismInformations;
         _typesTypes[4492] = GameRolePlayPortalInformations;
         _typesTypes[2731] = GameContextActorInformations;
         _typesTypes[1336] = GameFightFighterInformations;
         _typesTypes[8962] = GameFightAIInformations;
         _typesTypes[7996] = GameFightMonsterInformations;
         ...
         _typesTypes[1935] = GameRolePlayPrismInformations;
         _typesTypes[4492] = GameRolePlayPortalInformations;
         _typesTypes[3552] = HumanInformations;
         _typesTypes[9012] = HumanOption;
         _typesTypes[9917] = HumanOptionObjectUse;
         _typesTypes[4905] = HumanOptionAlliance;
         _typesTypes[9583] = HumanOptionGuild;
         _typesTypes[2913] = HumanOptionOrnament;
         _typesTypes[9108] = HumanOptionEmote;
         _typesTypes[5285] = HumanOptionTitle;
         _typesTypes[7124] = HumanOptionSkillUse;
         _typesTypes[7522] = HumanOptionSpeedMultiplier;
         _typesTypes[2344] = HumanOptionFollowers;
         _typesTypes[4251] = TaxCollectorStaticInformations;
         _typesTypes[3048] = TaxCollectorStaticExtendedInformations;
         _typesTypes[1698] = TaxCollectorInformations;
         _typesTypes[1761] = TaxCollectorComplementaryInformations;
         _typesTypes[3945] = TaxCollectorGuildInformations;
         _typesTypes[31] = TaxCollectorLootInformations;
         _typesTypes[5219] = TaxCollectorWaitingForHelpInformations;
         _typesTypes[7530] = GroupMonsterStaticInformations;
         _typesTypes[4706] = GroupMonsterStaticInformationsWithAlternatives;
         _typesTypes[7467] = QuestActiveInformations;
         _typesTypes[1711] = QuestActiveDetailedInformations;
         _typesTypes[7608] = QuestObjectiveInformations;
         _typesTypes[8445] = QuestObjectiveInformationsWithCompletion;
         _typesTypes[4164] = SpawnInformation;
         _typesTypes[7820] = BaseSpawnMonsterInformation;
         _typesTypes[4208] = SpawnScaledMonsterInformation;
         _typesTypes[4683] = SpawnMonsterInformation;
         _typesTypes[8127] = SpawnCharacterInformation;
         _typesTypes[5290] = SpawnCompanionInformation;
         _typesTypes[5258] = GameContextBasicSpawnInformation;
         _typesTypes[4966] = GameContextSummonsInformation;
         _typesTypes[1336] = GameFightFighterInformations;
         _typesTypes[8962] = GameFightAIInformations;
         _typesTypes[7996] = GameFightMonsterInformations;
         _typesTypes[685] = GameFightMonsterWithAlignmentInformations;
         ...
         _typesTypes[5304] = GameFightMutantInformations;
         _typesTypes[9037] = GameFightEntityInformation;
         _typesTypes[8097] = GameFightFighterLightInformations;
         _typesTypes[622] = GameFightFighterMonsterLightInformations;
         _typesTypes[7812] = GameFightFighterNamedLightInformations;
         _typesTypes[5273] = GameFightFighterTaxCollectorLightInformations;
         _typesTypes[125] = GameFightFighterEntityLightInformation;
         _typesTypes[3296] = MapCoordinates;
         _typesTypes[8277] = MapCoordinatesAndId;
         _typesTypes[6443] = MapCoordinatesExtended;
         _typesTypes[7679] = Preset;
         _typesTypes[3018] = PresetsContainerPreset;
         _typesTypes[9579] = IconNamedPreset;
         _typesTypes[4946] = SpellsPreset;
         _typesTypes[6946] = ForgettableSpellsPreset;
         _typesTypes[6299] = StatsPreset;
         _typesTypes[4104] = IdolsPreset;
         _typesTypes[7302] = EntitiesPreset;
         _typesTypes[6627] = FullStatsPreset;
         _typesTypes[5609] = ItemsPreset;
         _typesTypes[1380] = TreasureHuntStep;
         _typesTypes[3670] = TreasureHuntStepFollowDirectionToPOI;
         _typesTypes[3158] = TreasureHuntStepDig;
         _typesTypes[2025] = TreasureHuntStepFight;
         _typesTypes[1280] = TreasureHuntStepFollowDirectionToHint;
         _typesTypes[6206] = TreasureHuntStepFollowDirection;
         _typesTypes[1941] = AbstractPlayerSearchInformation;
         _typesTypes[9354] = PlayerSearchTagInformation;
         _typesTypes[2582] = PlayerSearchCharacterNameInformation;
         _typesTypes[7576] = PortalInformation;
         _typesTypes[4093] = BreachBranch;
         _typesTypes[2411] = ExtendedBreachBranch;
         _typesTypes[3360] = ExtendedLockedBreachBranch;
         _typesTypes[2411] = ExtendedBreachBranch;
         _typesTypes[3360] = ExtendedLockedBreachBranch;
         _typesTypes[2800] = PlayerStatus;
         _typesTypes[6689] = PlayerStatusExtended;
         _typesTypes[1655] = ServerSessionConstant;
         _typesTypes[1087] = ServerSessionConstantString;
         _typesTypes[6759] = ServerSessionConstantInteger;
         _typesTypes[7150] = ServerSessionConstantLong;
         _typesTypes[9976] = StatisticData;
         _typesTypes[5020] = StatisticDataInt;
         _typesTypes[1668] = StatisticDataBoolean;
         _typesTypes[4566] = StatisticDataShort;
         _typesTypes[3754] = StatisticDataString;
         _typesTypes[6014] = StatisticDataByte;
         _typesTypes[2197] = DebtInformation;
         _typesTypes[5100] = KamaDebtInformation;
         _typesTypes[9885] = GuildLogbookEntryBasicInformation;
         _typesTypes[6210] = GuildRankActivity;
         _typesTypes[2477] = GuildPlayerRankUpdateActivity;
         _typesTypes[4972] = GuildLogbookChestActivity;
         _typesTypes[6657] = GuildLevelUpActivity;
         _typesTypes[1038] = GuildPaddockActivity;
         _typesTypes[784] = GuildPlayerFlowActivity;
         _typesTypes[1415] = GuildUnlockNewTabActivity;
      }
