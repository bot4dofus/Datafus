package com.ankamagames.dofus.network
{
   ...
   public class MessageReceiver implements RawDataParser
   {
      ...
      {
         _messagesTypes[7053] = NetworkDataContainerMessage;
         _messagesTypes[11] = ProtocolRequired;
         _messagesTypes[3324] = LoginQueueStatusMessage;
         _messagesTypes[112] = QueueStatusMessage;
         _messagesTypes[2700] = ConsoleMessage;
         _messagesTypes[900] = ConsoleCommandsListMessage;
         _messagesTypes[9866] = HelloConnectMessage;
         _messagesTypes[6448] = CredentialsAcknowledgementMessage;
         _messagesTypes[8781] = NicknameRegistrationMessage;
         _messagesTypes[2445] = AccountLinkRequiredMessage;
         _messagesTypes[9664] = NicknameRefusedMessage;
         _messagesTypes[4756] = NicknameAcceptedMessage;
         _messagesTypes[5318] = IdentificationSuccessMessage;
         _messagesTypes[609] = IdentificationSuccessWithLoginTokenMessage;
         _messagesTypes[3599] = IdentificationFailedMessage;
         _messagesTypes[7810] = IdentificationFailedBannedMessage;
         _messagesTypes[6631] = IdentificationFailedForBadVersionMessage;
         _messagesTypes[2983] = ServersListMessage;
         _messagesTypes[3787] = ServerStatusUpdateMessage;
         _messagesTypes[4573] = SelectedServerDataMessage;
         _messagesTypes[1251] = SelectedServerDataExtendedMessage;
         _messagesTypes[4020] = SelectedServerRefusedMessage;
         _messagesTypes[2908] = AcquaintanceSearchErrorMessage;
         _messagesTypes[6161] = AcquaintanceServerListMessage;
         _messagesTypes[7608] = MigratedServerListMessage;
         _messagesTypes[3704] = HelloGameMessage;
         _messagesTypes[3574] = AuthenticationTicketAcceptedMessage;
         _messagesTypes[5757] = AuthenticationTicketRefusedMessage;
         _messagesTypes[7528] = AlreadyConnectedMessage;
         _messagesTypes[6873] = AccountLoggingKickedMessage;
         _messagesTypes[2663] = ReloginTokenStatusMessage;
         _messagesTypes[8887] = ServerSettingsMessage;
         _messagesTypes[1134] = ServerSessionConstantsMessage;
         _messagesTypes[2056] = ServerOptionalFeaturesMessage;
         _messagesTypes[4190] = AccountCapabilitiesMessage;
         _messagesTypes[7347] = TrustStatusMessage;
         _messagesTypes[8199] = AccountInformationsUpdateMessage;
         _messagesTypes[172] = CheckFileRequestMessage;
         _messagesTypes[7795] = RawDataMessage;
         _messagesTypes[6586] = StartupActionsListMessage;
         _messagesTypes[7593] = StartupActionAddMessage;
         _messagesTypes[1061] = StartupActionFinishedMessage;
         _messagesTypes[695] = CharacterCanBeCreatedResultMessage;
         _messagesTypes[1327] = CharacterCreationResultMessage;
         _messagesTypes[6502] = CharacterDeletionErrorMessage;
         _messagesTypes[3534] = CharacterNameSuggestionSuccessMessage;
         _messagesTypes[3181] = CharacterNameSuggestionFailureMessage;
         _messagesTypes[3938] = BasicCharactersListMessage;
         _messagesTypes[6672] = CharactersListMessage;
         _messagesTypes[1014] = CharactersListWithRemodelingMessage;
         _messagesTypes[8804] = CharactersListErrorMessage;
         _messagesTypes[9289] = CharacterSelectedSuccessMessage;
         _messagesTypes[3065] = CharacterSelectedForceMessage;
         _messagesTypes[4667] = CharacterSelectedErrorMessage;
         _messagesTypes[5529] = PopupWarningMessage;
         _messagesTypes[6279] = PopupWarningClosedMessage;
         _messagesTypes[5264] = BasicDateMessage;
         _messagesTypes[8387] = BasicTimeMessage;
         _messagesTypes[7284] = AlmanachCalendarDateMessage;
         _messagesTypes[5484] = BasicNoOperationMessage;
         _messagesTypes[338] = BasicAckMessage;
         _messagesTypes[2969] = SystemMessageDisplayMessage;
         _messagesTypes[7485] = TextInformationMessage;
         _messagesTypes[3832] = OnConnectionEventMessage;
         _messagesTypes[5617] = SetCharacterRestrictionsMessage;
         _messagesTypes[3783] = ServerExperienceModificatorMessage;
         _messagesTypes[8556] = CharacterCapabilitiesMessage;
         _messagesTypes[2973] = CharacterLoadingCompleteMessage;
         _messagesTypes[1649] = GameContextCreateMessage;
         _messagesTypes[4858] = GameContextCreateErrorMessage;
         _messagesTypes[4289] = GameContextDestroyMessage;
         _messagesTypes[9247] = GameContextRemoveElementMessage;
         _messagesTypes[7048] = GameContextRemoveMultipleElementsMessage;
         _messagesTypes[147] = GameContextRemoveElementWithEventMessage;
         _messagesTypes[5642] = GameContextRemoveMultipleElementsWithEventsMessage;
         _messagesTypes[1487] = GameContextMoveElementMessage;
         _messagesTypes[3656] = GameContextMoveMultipleElementsMessage;
         _messagesTypes[6845] = GameContextRefreshEntityLookMessage;
         _messagesTypes[2795] = GameMapSpeedMovementMessage;
         _messagesTypes[3268] = GameMapNoMovementMessage;
         _messagesTypes[5790] = GameMapMovementMessage;
         _messagesTypes[7761] = GameCautiousMapMovementMessage;
         _messagesTypes[4569] = GameMapChangeOrientationMessage;
         _messagesTypes[2531] = GameMapChangeOrientationsMessage;
         _messagesTypes[1676] = GameEntityDispositionMessage;
         _messagesTypes[8060] = GameEntitiesDispositionMessage;
         _messagesTypes[3724] = GameEntityDispositionErrorMessage;
         _messagesTypes[3360] = GameRefreshMonsterBoostsMessage;
         _messagesTypes[917] = PlayerStatusUpdateErrorMessage;
         _messagesTypes[4595] = PlayerStatusUpdateMessage;
         _messagesTypes[534] = BasicWhoIsMessage;
         _messagesTypes[8154] = BasicWhoIsNoMatchMessage;
         _messagesTypes[6454] = NumericWhoIsMessage;
         _messagesTypes[8994] = BasicPongMessage;
         _messagesTypes[1812] = BasicLatencyStatsRequestMessage;
         _messagesTypes[7059] = SequenceNumberRequestMessage;
         _messagesTypes[3329] = CurrentServerStatusUpdateMessage;
         _messagesTypes[6021] = CinematicMessage;
         _messagesTypes[1598] = DumpedEntityStatsMessage;
         _messagesTypes[4740] = DebugHighlightCellsMessage;
         _messagesTypes[4764] = DebugClearHighlightCellsMessage;
         _messagesTypes[7346] = DebugInClientMessage;
         _messagesTypes[3376] = ClientYouAreDrunkMessage;
         _messagesTypes[7505] = DisplayNumericalValuePaddockMessage;
         _messagesTypes[5327] = CurrentMapMessage;
         _messagesTypes[4005] = CurrentMapInstanceMessage;
         _messagesTypes[2811] = TeleportOnSameMapMessage;
         _messagesTypes[1882] = MapFightCountMessage;
         _messagesTypes[2079] = MapRunningFightListMessage;
         _messagesTypes[9142] = MapRunningFightDetailsMessage;
         _messagesTypes[673] = MapRunningFightDetailsExtendedMessage;
         _messagesTypes[4027] = MapObstacleUpdateMessage;
         _messagesTypes[4942] = MapComplementaryInformationsDataMessage;
         _messagesTypes[7269] = MapComplementaryInformationsDataInHouseMessage;
         _messagesTypes[251] = MapComplementaryInformationsWithCoordsMessage;
         _messagesTypes[9124] = MapRewardRateMessage;
         _messagesTypes[8758] = BreachEnterMessage;
         _messagesTypes[9084] = BreachTeleportResponseMessage;
         _messagesTypes[7916] = BreachRoomLockedMessage;
         _messagesTypes[2917] = BreachRoomUnlockResultMessage;
         _messagesTypes[7764] = BreachExitResponseMessage;
         _messagesTypes[7517] = MapComplementaryInformationsBreachMessage;
         _messagesTypes[1618] = BreachGameFightEndMessage;
         _messagesTypes[9186] = AnomalyStateMessage;
         _messagesTypes[3816] = MapComplementaryInformationsAnomalyMessage;
         _messagesTypes[9239] = MapFightStartPositionsUpdateMessage;
         _messagesTypes[3330] = GameRolePlayShowActorMessage;
         _messagesTypes[8034] = GameRolePlayShowMultipleActorsMessage;
         _messagesTypes[8598] = GameRolePlayShowActorWithEventMessage;
         _messagesTypes[4076] = CharacterStatsListMessage;
         _messagesTypes[2442] = FighterStatsListMessage;
         _messagesTypes[3380] = UpdateSpellModifierMessage;
         _messagesTypes[2329] = CharacterLevelUpMessage;
         _messagesTypes[6591] = CharacterExperienceGainMessage;
         _messagesTypes[5397] = CharacterLevelUpInformationMessage;
         _messagesTypes[1231] = UpdateLifePointsMessage;
         _messagesTypes[4874] = LifePointsRegenBeginMessage;
         _messagesTypes[5565] = LifePointsRegenEndMessage;
         _messagesTypes[7198] = GameRolePlayPlayerLifeStatusMessage;
         _messagesTypes[6762] = GameRolePlayGameOverMessage;
         _messagesTypes[3699] = GameRolePlayFightRequestCanceledMessage;
         _messagesTypes[830] = GameRolePlayAggressionMessage;
         _messagesTypes[3007] = GameRolePlayPlayerFightFriendlyRequestedMessage;
         _messagesTypes[3503] = GameRolePlayPlayerFightFriendlyAnsweredMessage;
         _messagesTypes[729] = GameRolePlayArenaRegistrationStatusMessage;
         _messagesTypes[2805] = GameRolePlayArenaFightPropositionMessage;
         _messagesTypes[2665] = GameRolePlayArenaFighterStatusMessage;
         _messagesTypes[1514] = GameRolePlayArenaUpdatePlayerInfosMessage;
         _messagesTypes[9745] = GameRolePlayArenaUpdatePlayerInfosAllQueuesMessage;
         _messagesTypes[5869] = GameRolePlayArenaSwitchToFightServerMessage;
         _messagesTypes[8886] = GameRolePlayArenaSwitchToGameServerMessage;
         _messagesTypes[7964] = GameRolePlayArenaInvitationCandidatesAnswerMessage;
         _messagesTypes[5275] = GameRolePlayArenaLeagueRewardsMessage;
         _messagesTypes[6801] = GameRolePlayArenaPlayerBehavioursMessage;
         _messagesTypes[2207] = GameRolePlayArenaRegistrationWarningMessage;
         _messagesTypes[5336] = GameRolePlayMonsterAngryAtPlayerMessage;
         _messagesTypes[9341] = GameRolePlayMonsterNotAngryAtPlayerMessage;
         _messagesTypes[4981] = GameRolePlayShowChallengeMessage;
         _messagesTypes[8509] = GameRolePlayRemoveChallengeMessage;
         _messagesTypes[1994] = GameRolePlaySpellAnimMessage;
         _messagesTypes[1773] = GameRolePlayDelayedActionMessage;
         _messagesTypes[156] = GameRolePlayDelayedObjectUseMessage;
         _messagesTypes[7544] = GameRolePlayDelayedActionFinishedMessage;
         _messagesTypes[1966] = ShowCellMessage;
         _messagesTypes[5049] = ShowCellSpectatorMessage;
         _messagesTypes[1785] = GameFightStartingMessage;
         _messagesTypes[5028] = GameFightJoinMessage;
         _messagesTypes[5184] = GameFightSpectatorJoinMessage;
         _messagesTypes[2379] = GameFightPlacementPossiblePositionsMessage;
         _messagesTypes[1476] = GameFightPlacementSwapPositionsErrorMessage;
         _messagesTypes[9954] = GameFightPlacementSwapPositionsOfferMessage;
         _messagesTypes[8151] = GameFightPlacementSwapPositionsCancelledMessage;
         _messagesTypes[9992] = GameFightPlacementSwapPositionsMessage;
         _messagesTypes[4968] = GameFightOptionStateUpdateMessage;
         _messagesTypes[7193] = GameFightUpdateTeamMessage;
         _messagesTypes[5896] = GameFightRemoveTeamMemberMessage;
         _messagesTypes[6661] = GameFightHumanReadyStateMessage;
         _messagesTypes[7598] = GameFightLeaveMessage;
         _messagesTypes[5936] = GameFightStartMessage;
         _messagesTypes[3129] = GameFightSpectateMessage;
         _messagesTypes[348] = GameFightResumeMessage;
         _messagesTypes[7604] = GameFightResumeWithSlavesMessage;
         _messagesTypes[8476] = GameFightEndMessage;
         _messagesTypes[8623] = GameFightNewRoundMessage;
         _messagesTypes[3381] = GameFightTurnListMessage;
         _messagesTypes[3207] = GameFightTurnStartMessage;
         _messagesTypes[7707] = GameFightNewWaveMessage;
         _messagesTypes[4192] = GameFightTurnStartPlayingMessage;
         _messagesTypes[3983] = GameFightTurnResumeMessage;
         _messagesTypes[5395] = GameFightPauseMessage;
         _messagesTypes[3371] = SlaveSwitchContextMessage;
         _messagesTypes[3140] = SlaveNoLongerControledMessage;
         _messagesTypes[4571] = RefreshCharacterStatsMessage;
         _messagesTypes[1674] = GameFightTurnReadyRequestMessage;
         _messagesTypes[5930] = GameFightSynchronizeMessage;
         _messagesTypes[816] = GameFightTurnEndMessage;
         _messagesTypes[8928] = GameFightShowFighterMessage;
         _messagesTypes[383] = GameFightRefreshFighterMessage;
         _messagesTypes[9048] = GameFightShowFighterRandomStaticPoseMessage;
         _messagesTypes[1206] = ArenaFighterLeaveMessage;
         _messagesTypes[3086] = ArenaFighterIdleMessage;
         _messagesTypes[2376] = SequenceStartMessage;
         _messagesTypes[5434] = SequenceEndMessage;
         _messagesTypes[3221] = AbstractGameActionMessage;
         _messagesTypes[4755] = GameActionNoopMessage;
         _messagesTypes[3299] = GameActionSpamMessage;
         _messagesTypes[6275] = AbstractGameActionWithAckMessage;
         _messagesTypes[5083] = GameActionFightNoSpellCastMessage;
         _messagesTypes[4725] = AbstractGameActionFightTargetedAbilityMessage;
         _messagesTypes[7652] = GameActionFightSpellCastMessage;
         _messagesTypes[3323] = GameActionFightCloseCombatMessage;
         _messagesTypes[224] = GameActionUpdateEffectTriggerCountMessage;
         _messagesTypes[5039] = GameActionFightInvisibleDetectedMessage;
         _messagesTypes[1771] = GameActionFightPointsVariationMessage;
         _messagesTypes[4292] = GameActionFightTackledMessage;
         _messagesTypes[9553] = GameActionFightDeathMessage;
         _messagesTypes[1973] = GameActionFightKillMessage;
         _messagesTypes[5886] = GameActionFightVanishMessage;
         _messagesTypes[9180] = GameActionFightSpellCooldownVariationMessage;
         _messagesTypes[2406] = GameActionFightSpellImmunityMessage;
         _messagesTypes[8348] = GameActionFightLifePointsGainMessage;
         _messagesTypes[4760] = GameActionFightLifePointsLostMessage;
         _messagesTypes[3269] = GameActionFightLifeAndShieldPointsLostMessage;
         _messagesTypes[2070] = GameActionFightDispellableEffectMessage;
         _messagesTypes[522] = GameActionFightReflectSpellMessage;
         _messagesTypes[2939] = GameActionFightReduceDamagesMessage;
         _messagesTypes[7630] = GameActionFightReflectDamagesMessage;
         _messagesTypes[497] = GameActionFightDodgePointLossMessage;
         _messagesTypes[9215] = GameActionFightSlideMessage;
         _messagesTypes[9252] = GameActionFightTeleportOnSameMapMessage;
         _messagesTypes[9823] = GameActionFightExchangePositionsMessage;
         _messagesTypes[6808] = GameActionFightDispellMessage;
         _messagesTypes[7249] = GameActionFightDispellEffectMessage;
         _messagesTypes[2368] = GameActionFightDispellSpellMessage;
         _messagesTypes[2763] = GameActionFightModifyEffectsDurationMessage;
         _messagesTypes[7353] = GameActionFightTriggerEffectMessage;
         _messagesTypes[6674] = GameActionFightStealKamaMessage;
         _messagesTypes[7431] = GameActionFightChangeLookMessage;
         _messagesTypes[1307] = GameActionFightInvisibilityMessage;
         _messagesTypes[3623] = GameActionFightSummonMessage;
         _messagesTypes[693] = GameActionFightMultipleSummonMessage;
         _messagesTypes[2942] = GameActionFightMarkCellsMessage;
         _messagesTypes[6239] = GameActionFightUnmarkCellsMessage;
         _messagesTypes[6980] = GameActionFightTriggerGlyphTrapMessage;
         _messagesTypes[5244] = GameActionFightActivateGlyphTrapMessage;
         _messagesTypes[4585] = GameActionFightCarryCharacterMessage;
         _messagesTypes[425] = GameActionFightThrowCharacterMessage;
         _messagesTypes[7126] = GameActionFightDropCharacterMessage;
         _messagesTypes[3161] = EmoteListMessage;
         _messagesTypes[5101] = EmoteAddMessage;
         _messagesTypes[4900] = EmoteRemoveMessage;
         _messagesTypes[3940] = EmotePlayAbstractMessage;
         _messagesTypes[9984] = EmotePlayMessage;
         _messagesTypes[6229] = EmotePlayMassiveMessage;
         _messagesTypes[638] = EmotePlayErrorMessage;
         _messagesTypes[9149] = ChatSmileyMessage;
         _messagesTypes[2069] = ChatCommunityChannelCommunityMessage;
         _messagesTypes[9156] = LocalizedChatSmileyMessage;
         _messagesTypes[9391] = MoodSmileyResultMessage;
         _messagesTypes[2832] = MoodSmileyUpdateMessage;
         _messagesTypes[3355] = ChatSmileyExtraPackListMessage;
         _messagesTypes[2330] = ChatAbstractServerMessage;
         _messagesTypes[6654] = ChatServerMessage;
         _messagesTypes[7803] = ChatKolizeumServerMessage;
         _messagesTypes[4636] = ChatAdminServerMessage;
         _messagesTypes[4589] = ChatServerWithObjectMessage;
         _messagesTypes[1151] = ChatServerCopyMessage;
         _messagesTypes[6746] = ChatServerCopyWithObjectMessage;
         _messagesTypes[8334] = ChatErrorMessage;
         _messagesTypes[8277] = EnabledChannelsMessage;
         _messagesTypes[9458] = ChannelEnablingChangeMessage;
         _messagesTypes[2380] = SpellListMessage;
         _messagesTypes[8207] = ForgettableSpellListUpdateMessage;
         _messagesTypes[1347] = ForgettableSpellDeleteMessage;
         _messagesTypes[9886] = ForgettableSpellEquipmentSlotsMessage;
         _messagesTypes[6750] = LeaveDialogMessage;
         _messagesTypes[7928] = PauseDialogMessage;
         _messagesTypes[3364] = InteractiveUseErrorMessage;
         _messagesTypes[3805] = InteractiveUsedMessage;
         _messagesTypes[4007] = InteractiveUseEndedMessage;
         _messagesTypes[8408] = InteractiveMapUpdateMessage;
         _messagesTypes[7905] = StatedMapUpdateMessage;
         _messagesTypes[1345] = InteractiveElementUpdatedMessage;
         _messagesTypes[3410] = StatedElementUpdatedMessage;
         _messagesTypes[9480] = ZaapRespawnUpdatedMessage;
         _messagesTypes[8201] = TeleportDestinationsMessage;
         _messagesTypes[2726] = ZaapDestinationsMessage;
         _messagesTypes[1029] = KnownZaapListMessage;
         _messagesTypes[6421] = TeleportBuddiesMessage;
         _messagesTypes[8902] = TeleportBuddiesRequestedMessage;
         _messagesTypes[6240] = TeleportToBuddyOfferMessage;
         _messagesTypes[5848] = TeleportToBuddyCloseMessage;
         _messagesTypes[9850] = SpellVariantActivationMessage;
         _messagesTypes[6458] = StatsUpgradeResultMessage;
         _messagesTypes[9820] = ChallengeTargetsListMessage;
         _messagesTypes[464] = ChallengeInfoMessage;
         _messagesTypes[4406] = ChallengeTargetUpdateMessage;
         _messagesTypes[7613] = ChallengeResultMessage;
         _messagesTypes[2767] = EntityInformationMessage;
         _messagesTypes[7946] = EntitiesInformationMessage;
         _messagesTypes[1057] = IdolSelectErrorMessage;
         _messagesTypes[6423] = IdolSelectedMessage;
         _messagesTypes[6939] = IdolListMessage;
         _messagesTypes[3662] = IdolPartyRefreshMessage;
         _messagesTypes[4706] = IdolPartyLostMessage;
         _messagesTypes[9303] = IdolFightPreparationUpdateMessage;
         _messagesTypes[8638] = AchievementListMessage;
         _messagesTypes[4300] = AchievementDetailsMessage;
         _messagesTypes[4413] = AchievementDetailedListMessage;
         _messagesTypes[2017] = AchievementAlmostFinishedDetailedListMessage;
         _messagesTypes[3128] = AchievementFinishedMessage;
         _messagesTypes[5334] = AchievementFinishedInformationMessage;
         _messagesTypes[3229] = AchievementRewardSuccessMessage;
         _messagesTypes[4534] = AchievementRewardErrorMessage;
         _messagesTypes[8019] = FriendGuildWarnOnAchievementCompleteStateMessage;
         _messagesTypes[222] = DungeonKeyRingMessage;
         _messagesTypes[630] = DungeonKeyRingUpdateMessage;
         _messagesTypes[3888] = UpdateMapPlayersAgressableStatusMessage;
         _messagesTypes[3863] = UpdateSelfAgressableStatusMessage;
         _messagesTypes[9586] = AlignmentRankUpdateMessage;
         _messagesTypes[9951] = CompassResetMessage;
         _messagesTypes[486] = CompassUpdateMessage;
         _messagesTypes[883] = CompassUpdatePartyMemberMessage;
         _messagesTypes[586] = AtlasPointInformationsMessage;
         _messagesTypes[2528] = CompassUpdatePvpSeekMessage;
         _messagesTypes[6695] = AbstractPartyMessage;
         _messagesTypes[5285] = AbstractPartyEventMessage;
         _messagesTypes[5877] = PartyModifiableStatusMessage;
         _messagesTypes[657] = PartyInvitationMessage;
         _messagesTypes[114] = PartyInvitationDungeonMessage;
         _messagesTypes[6946] = PartyInvitationDetailsMessage;
         _messagesTypes[9045] = PartyInvitationDungeonDetailsMessage;
         _messagesTypes[5131] = PartyInvitationCancelledForGuestMessage;
         _messagesTypes[4659] = PartyCancelInvitationNotificationMessage;
         _messagesTypes[4272] = PartyRefuseInvitationNotificationMessage;
         _messagesTypes[9481] = PartyCannotJoinErrorMessage;
         _messagesTypes[5579] = PartyJoinMessage;
         _messagesTypes[144] = PartyNewGuestMessage;
         _messagesTypes[8916] = PartyUpdateMessage;
         _messagesTypes[3491] = PartyNewMemberMessage;
         _messagesTypes[150] = PartyUpdateLightMessage;
         _messagesTypes[4938] = PartyEntityUpdateLightMessage;
         _messagesTypes[6639] = PartyMemberRemoveMessage;
         _messagesTypes[75] = PartyMemberEjectedMessage;
         _messagesTypes[3035] = PartyLeaderUpdateMessage;
         _messagesTypes[548] = PartyFollowStatusUpdateMessage;
         _messagesTypes[8309] = PartyLocateMembersMessage;
         _messagesTypes[1503] = PartyLeaveMessage;
         _messagesTypes[7866] = PartyKickedByMessage;
         _messagesTypes[5335] = PartyRestrictedMessage;
         _messagesTypes[6498] = PartyDeletedMessage;
         _messagesTypes[1509] = PartyLoyaltyStatusMessage;
         _messagesTypes[6079] = AbstractPartyMemberInFightMessage;
         _messagesTypes[8647] = PartyMemberInStandardFightMessage;
         _messagesTypes[6247] = PartyMemberInBreachFightMessage;
         _messagesTypes[5708] = PartyNameUpdateMessage;
         _messagesTypes[3671] = PartyNameSetErrorMessage;
         _messagesTypes[8821] = DungeonPartyFinderAvailableDungeonsMessage;
         _messagesTypes[5786] = DungeonPartyFinderListenErrorMessage;
         _messagesTypes[5358] = DungeonPartyFinderRoomContentMessage;
         _messagesTypes[3212] = DungeonPartyFinderRoomContentUpdateMessage;
         _messagesTypes[7313] = DungeonPartyFinderRegisterSuccessMessage;
         _messagesTypes[6133] = DungeonPartyFinderRegisterErrorMessage;
         _messagesTypes[898] = ContactAddFailureMessage;
         _messagesTypes[4490] = SpouseStatusMessage;
         _messagesTypes[1267] = FriendsListMessage;
         _messagesTypes[3517] = AcquaintancesListMessage;
         _messagesTypes[4509] = SpouseInformationsMessage;
         _messagesTypes[2303] = FriendAddFailureMessage;
         _messagesTypes[9990] = AcquaintanceAddedMessage;
         _messagesTypes[3186] = FriendAddedMessage;
         _messagesTypes[6419] = FriendUpdateMessage;
         _messagesTypes[971] = FriendDeleteResultMessage;
         _messagesTypes[559] = FriendWarnOnConnectionStateMessage;
         _messagesTypes[6562] = WarnOnPermaDeathStateMessage;
         _messagesTypes[6840] = FriendWarnOnLevelGainStateMessage;
         _messagesTypes[1664] = FriendStatusShareStateMessage;
         _messagesTypes[8166] = IgnoredListMessage;
         _messagesTypes[9700] = IgnoredAddFailureMessage;
         _messagesTypes[6681] = IgnoredAddedMessage;
         _messagesTypes[7962] = IgnoredDeleteResultMessage;
         _messagesTypes[3265] = AllianceCreationStartedMessage;
         _messagesTypes[228] = AllianceModificationStartedMessage;
         _messagesTypes[6996] = AllianceCreationResultMessage;
         _messagesTypes[7670] = AllianceInvitedMessage;
         _messagesTypes[3541] = AllianceInvitationStateRecruterMessage;
         _messagesTypes[4243] = AllianceInvitationStateRecrutedMessage;
         _messagesTypes[3754] = AllianceJoinedMessage;
         _messagesTypes[7205] = AllianceGuildLeavingMessage;
         _messagesTypes[5727] = AllianceLeftMessage;
         _messagesTypes[1330] = AllianceMembershipMessage;
         _messagesTypes[871] = KohUpdateMessage;
         _messagesTypes[3901] = AreaFightModificatorUpdateMessage;
         _messagesTypes[6580] = ClientUIOpenedMessage;
         _messagesTypes[7549] = ClientUIOpenedByObjectMessage;
         _messagesTypes[6572] = GuildCreationStartedMessage;
         _messagesTypes[463] = GuildModificationStartedMessage;
         _messagesTypes[8099] = GuildCreationResultMessage;
         _messagesTypes[9469] = GuildInvitedMessage;
         _messagesTypes[2098] = GuildInvitationStateRecruterMessage;
         _messagesTypes[7805] = GuildInvitationStateRecrutedMessage;
         _messagesTypes[8452] = GuildJoinedMessage;
         _messagesTypes[8475] = GuildMemberOnlineStatusMessage;
         _messagesTypes[5087] = GuildInformationsGeneralMessage;
         _messagesTypes[1003] = GuildInformationsMembersMessage;
         _messagesTypes[8773] = GuildInformationsMemberUpdateMessage;
         _messagesTypes[2545] = GuildInformationsPaddocksMessage;
         _messagesTypes[6226] = GuildMemberLeavingMessage;
         _messagesTypes[5198] = GuildLeftMessage;
         _messagesTypes[2165] = GuildMembershipMessage;
         _messagesTypes[2569] = GuildLevelUpMessage;
         _messagesTypes[9908] = GuildInfosUpgradeMessage;
         _messagesTypes[5494] = GuildHousesInformationMessage;
         _messagesTypes[2091] = GuildHouseUpdateInformationMessage;
         _messagesTypes[9785] = GuildHouseRemoveMessage;
         _messagesTypes[6136] = GuildPaddockBoughtMessage;
         _messagesTypes[5829] = GuildPaddockRemovedMessage;
         _messagesTypes[8315] = GuildMemberWarnOnConnectionStateMessage;
         _messagesTypes[5839] = GuildMotdMessage;
         _messagesTypes[1018] = GuildMotdSetErrorMessage;
         _messagesTypes[8491] = GuildBulletinMessage;
         _messagesTypes[6856] = GuildBulletinSetErrorMessage;
         _messagesTypes[7481] = GuildFactsErrorMessage;
         _messagesTypes[6322] = GuildFactsMessage;
         _messagesTypes[9827] = GuildInAllianceFactsMessage;
         _messagesTypes[7325] = AllianceFactsErrorMessage;
         _messagesTypes[7933] = AllianceFactsMessage;
         _messagesTypes[6635] = GuildListMessage;
         _messagesTypes[7464] = GuildVersatileInfoListMessage;
         _messagesTypes[9015] = AllianceListMessage;
         _messagesTypes[4970] = AllianceVersatileInfoListMessage;
         _messagesTypes[6341] = AlliancePartialListMessage;
         _messagesTypes[6932] = AllianceInsiderInfoMessage;
         _messagesTypes[1874] = AllianceMotdMessage;
         _messagesTypes[8457] = AllianceMotdSetErrorMessage;
         _messagesTypes[9097] = AllianceBulletinMessage;
         _messagesTypes[5502] = AllianceBulletinSetErrorMessage;
         _messagesTypes[5845] = TaxCollectorMovementMessage;
         _messagesTypes[262] = TaxCollectorErrorMessage;
         _messagesTypes[62] = AbstractTaxCollectorListMessage;
         _messagesTypes[7236] = TaxCollectorListMessage;
         _messagesTypes[7653] = TopTaxCollectorListMessage;
         _messagesTypes[7152] = TaxCollectorStateUpdateMessage;
         _messagesTypes[1356] = TaxCollectorMovementAddMessage;
         _messagesTypes[9819] = TaxCollectorMovementRemoveMessage;
         _messagesTypes[8528] = TaxCollectorAttackedMessage;
         _messagesTypes[9157] = TaxCollectorAttackedResultMessage;
         _messagesTypes[178] = GuildFightPlayersHelpersJoinMessage;
         _messagesTypes[5882] = GuildFightPlayersHelpersLeaveMessage;
         _messagesTypes[4673] = GuildFightPlayersEnemiesListMessage;
         _messagesTypes[6514] = GuildFightPlayersEnemyRemoveMessage;
         _messagesTypes[8067] = TaxCollectorMovementsOfflineMessage;
         _messagesTypes[6189] = PrismSetSabotagedRefusedMessage;
         _messagesTypes[3307] = PrismFightDefenderAddMessage;
         _messagesTypes[7104] = PrismFightDefenderLeaveMessage;
         _messagesTypes[4363] = PrismFightAttackerAddMessage;
         _messagesTypes[8906] = PrismFightAttackerRemoveMessage;
         _messagesTypes[1981] = PrismsListMessage;
         _messagesTypes[1949] = PrismsListUpdateMessage;
         _messagesTypes[795] = ChallengeFightJoinRefusedMessage;
         _messagesTypes[5182] = PrismInfoCloseMessage;
         _messagesTypes[5200] = PrismsInfoValidMessage;
         _messagesTypes[180] = PrismFightAddedMessage;
         _messagesTypes[2858] = PrismFightRemovedMessage;
         _messagesTypes[1525] = PrismInfoInValidMessage;
         _messagesTypes[9836] = PrismFightStateUpdateMessage;
         _messagesTypes[9936] = PrismSettingsErrorMessage;
         _messagesTypes[1903] = QuestListMessage;
         _messagesTypes[6148] = QuestStartedMessage;
         _messagesTypes[3439] = QuestValidatedMessage;
         _messagesTypes[7975] = QuestObjectiveValidatedMessage;
         _messagesTypes[1717] = QuestStepValidatedMessage;
         _messagesTypes[6634] = QuestStepStartedMessage;
         _messagesTypes[2657] = QuestStepInfoMessage;
         _messagesTypes[5477] = FollowedQuestsMessage;
         _messagesTypes[181] = WatchQuestStepInfoMessage;
         _messagesTypes[1080] = WatchQuestListMessage;
         _messagesTypes[4604] = NotificationListMessage;
         _messagesTypes[5480] = NotificationByServerMessage;
         _messagesTypes[7567] = SubscriptionLimitationMessage;
         _messagesTypes[6309] = SubscriptionZoneMessage;
         _messagesTypes[3089] = GuestLimitationMessage;
         _messagesTypes[1696] = GuestModeMessage;
         _messagesTypes[5114] = ListMapNpcsQuestStatusUpdateMessage;
         _messagesTypes[9882] = NpcGenericActionFailureMessage;
         _messagesTypes[2812] = PortalDialogCreationMessage;
         _messagesTypes[7250] = NpcDialogCreationMessage;
         _messagesTypes[2308] = NpcDialogQuestionMessage;
         _messagesTypes[2260] = TaxCollectorDialogQuestionBasicMessage;
         _messagesTypes[7914] = TaxCollectorDialogQuestionExtendedMessage;
         _messagesTypes[2759] = AllianceTaxCollectorDialogQuestionExtendedMessage;
         _messagesTypes[4234] = AlliancePrismDialogQuestionMessage;
         _messagesTypes[5602] = EntityTalkMessage;
         _messagesTypes[2706] = JobDescriptionMessage;
         _messagesTypes[1201] = JobLevelUpMessage;
         _messagesTypes[3713] = JobExperienceMultiUpdateMessage;
         _messagesTypes[289] = JobExperienceUpdateMessage;
         _messagesTypes[7051] = JobExperienceOtherPlayerUpdateMessage;
         _messagesTypes[9549] = JobAllowMultiCraftRequestMessage;
         _messagesTypes[9284] = JobMultiCraftAvailableSkillsMessage;
         _messagesTypes[7407] = JobCrafterDirectoryListMessage;
         _messagesTypes[2564] = JobCrafterDirectorySettingsMessage;
         _messagesTypes[2861] = JobBookSubscriptionMessage;
         _messagesTypes[3580] = JobCrafterDirectoryRemoveMessage;
         _messagesTypes[5726] = JobCrafterDirectoryAddMessage;
         _messagesTypes[5394] = JobCrafterDirectoryEntryMessage;
         _messagesTypes[2594] = KamasUpdateMessage;
         _messagesTypes[2720] = ObjectGroundAddedMessage;
         _messagesTypes[2933] = ObjectGroundListAddedMessage;
         _messagesTypes[326] = ObjectGroundRemovedMessage;
         _messagesTypes[2519] = ObjectGroundRemovedMultipleMessage;
         _messagesTypes[393] = InventoryContentMessage;
         _messagesTypes[1471] = WatchInventoryContentMessage;
         _messagesTypes[9690] = ShortcutBarContentMessage;
         _messagesTypes[8344] = ShortcutBarAddErrorMessage;
         _messagesTypes[7262] = ShortcutBarRemoveErrorMessage;
         _messagesTypes[4792] = ShortcutBarSwapErrorMessage;
         _messagesTypes[9342] = ShortcutBarRefreshMessage;
         _messagesTypes[8612] = ShortcutBarRemovedMessage;
         _messagesTypes[8774] = ShortcutBarReplacedMessage;
         _messagesTypes[4840] = StorageInventoryContentMessage;
         _messagesTypes[3235] = StorageKamasUpdateMessage;
         _messagesTypes[5367] = StorageObjectUpdateMessage;
         _messagesTypes[8931] = StorageObjectsUpdateMessage;
         _messagesTypes[4480] = StorageObjectRemoveMessage;
         _messagesTypes[7279] = StorageObjectsRemoveMessage;
         _messagesTypes[1474] = SetUpdateMessage;
         _messagesTypes[8949] = InventoryWeightMessage;
         _messagesTypes[7330] = ObjectMovementMessage;
         _messagesTypes[7280] = ObjectAddedMessage;
         _messagesTypes[7575] = ObjectsAddedMessage;
         _messagesTypes[6673] = GoldAddedMessage;
         _messagesTypes[4061] = ObjectErrorMessage;
         _messagesTypes[4420] = ObjectDeletedMessage;
         _messagesTypes[1915] = ObjectsDeletedMessage;
         _messagesTypes[43] = ObjectQuantityMessage;
         _messagesTypes[3115] = ObjectsQuantityMessage;
         _messagesTypes[9863] = ObjectModifiedMessage;
         _messagesTypes[2415] = ObjectJobAddedMessage;
         _messagesTypes[9144] = ObtainedItemMessage;
         _messagesTypes[2940] = ObtainedItemWithBonusMessage;
         _messagesTypes[5723] = LivingObjectMessageMessage;
         _messagesTypes[8001] = SymbioticObjectErrorMessage;
         _messagesTypes[4527] = SymbioticObjectAssociatedMessage;
         _messagesTypes[9494] = WrapperObjectErrorMessage;
         _messagesTypes[7472] = WrapperObjectAssociatedMessage;
         _messagesTypes[3566] = MimicryObjectPreviewMessage;
         _messagesTypes[7405] = MimicryObjectErrorMessage;
         _messagesTypes[2176] = MimicryObjectAssociatedMessage;
         _messagesTypes[5236] = InvalidPresetsMessage;
         _messagesTypes[6739] = PresetsMessage;
         _messagesTypes[8107] = ItemForPresetUpdateMessage;
         _messagesTypes[4251] = PresetSavedMessage;
         _messagesTypes[2990] = PresetSaveErrorMessage;
         _messagesTypes[59] = PresetDeleteResultMessage;
         _messagesTypes[4327] = PresetUseResultMessage;
         _messagesTypes[3052] = PresetUseResultWithMissingIdsMessage;
         _messagesTypes[5381] = ExchangeMoneyMovementInformationMessage;
         _messagesTypes[8145] = ExchangeCraftCountModifiedMessage;
         _messagesTypes[1308] = ExchangeObjectMessage;
         _messagesTypes[1780] = ExchangeObjectAddedMessage;
         _messagesTypes[4042] = ExchangeObjectsAddedMessage;
         _messagesTypes[2952] = ExchangeObjectRemovedMessage;
         _messagesTypes[6258] = ExchangeObjectsRemovedMessage;
         _messagesTypes[431] = ExchangeObjectModifiedMessage;
         _messagesTypes[1026] = ExchangeObjectsModifiedMessage;
         _messagesTypes[5351] = ExchangeObjectPutInBagMessage;
         _messagesTypes[1803] = ExchangeObjectRemovedFromBagMessage;
         _messagesTypes[6439] = ExchangeObjectModifiedInBagMessage;
         _messagesTypes[2333] = ExchangeKamaModifiedMessage;
         _messagesTypes[7185] = ExchangePodsModifiedMessage;
         _messagesTypes[5399] = ExchangeMultiCraftCrafterCanUseHisRessourcesMessage;
         _messagesTypes[1867] = ExchangeRequestedMessage;
         _messagesTypes[3067] = ExchangeRequestedTradeMessage;
         _messagesTypes[8253] = ExchangeStartedMessage;
         _messagesTypes[4010] = ExchangeStartedWithPodsMessage;
         _messagesTypes[1714] = ExchangeStartedWithStorageMessage;
         _messagesTypes[6172] = ExchangeBidHouseBuyResultMessage;
         _messagesTypes[7799] = ExchangeBidHouseItemAddOkMessage;
         _messagesTypes[5212] = ExchangeBidHouseItemRemoveOkMessage;
         _messagesTypes[2608] = ExchangeBidHouseGenericItemAddedMessage;
         _messagesTypes[5425] = ExchangeBidHouseGenericItemRemovedMessage;
         _messagesTypes[4065] = ExchangeBidHouseInListAddedMessage;
         _messagesTypes[3804] = ExchangeBidHouseInListUpdatedMessage;
         _messagesTypes[450] = ExchangeBidHouseInListRemovedMessage;
         _messagesTypes[2311] = ExchangeBidHouseUnsoldItemsMessage;
         _messagesTypes[9236] = ExchangeOfflineSoldItemsMessage;
         _messagesTypes[4036] = ExchangeIsReadyMessage;
         _messagesTypes[3827] = ExchangeStoppedMessage;
         _messagesTypes[7701] = ExchangeErrorMessage;
         _messagesTypes[1892] = ExchangeLeaveMessage;
         _messagesTypes[9905] = DecraftResultMessage;
         _messagesTypes[9039] = RecycleResultMessage;
         _messagesTypes[7698] = ExchangeStartOkNpcTradeMessage;
         _messagesTypes[903] = ExchangeStartOkRunesTradeMessage;
         _messagesTypes[9948] = ExchangeStartOkEvolutiveObjectRecycleTradeMessage;
         _messagesTypes[3493] = EvolutiveObjectRecycleResultMessage;
         _messagesTypes[1914] = ExchangeStartOkRecycleTradeMessage;
         _messagesTypes[7637] = ExchangeStartOkNpcShopMessage;
         _messagesTypes[1467] = ExchangeOkMultiCraftMessage;
         _messagesTypes[2664] = ExchangeCraftResultMessage;
         _messagesTypes[9065] = ExchangeCraftResultWithObjectIdMessage;
         _messagesTypes[5626] = ExchangeCraftResultWithObjectDescMessage;
         _messagesTypes[9513] = ExchangeCraftResultMagicWithObjectDescMessage;
         _messagesTypes[7458] = ExchangeStartOkHumanVendorMessage;
         _messagesTypes[4428] = ExchangeShopStockStartedMessage;
         _messagesTypes[3338] = ExchangeShopStockMovementUpdatedMessage;
         _messagesTypes[7874] = ExchangeShopStockMultiMovementUpdatedMessage;
         _messagesTypes[5089] = ExchangeShopStockMovementRemovedMessage;
         _messagesTypes[7363] = ExchangeShopStockMultiMovementRemovedMessage;
         _messagesTypes[2283] = ExchangeStartedMountStockMessage;
         _messagesTypes[3881] = ExchangeStartedTaxCollectorShopMessage;
         _messagesTypes[1377] = ExchangeStartedBidSellerMessage;
         _messagesTypes[9894] = ExchangeStartedBidBuyerMessage;
         _messagesTypes[4090] = ExchangeBidPriceMessage;
         _messagesTypes[9884] = ExchangeBidPriceForSellerMessage;
         _messagesTypes[2881] = ExchangeTypesExchangerDescriptionForUserMessage;
         _messagesTypes[5606] = ExchangeTypesItemsExchangerDescriptionForUserMessage;
         _messagesTypes[1011] = ExchangeWeightMessage;
         _messagesTypes[9024] = ExchangeGuildTaxCollectorGetMessage;
         _messagesTypes[3791] = ItemNoMoreAvailableMessage;
         _messagesTypes[6567] = ExchangeBuyOkMessage;
         _messagesTypes[3985] = ExchangeSellOkMessage;
         _messagesTypes[3498] = ExchangeReplyTaxVendorMessage;
         _messagesTypes[5707] = ExchangeWaitingResultMessage;
         _messagesTypes[2186] = ExchangeStartOkMountWithOutPaddockMessage;
         _messagesTypes[909] = ExchangeStartOkMountMessage;
         _messagesTypes[8768] = ExchangeMountStableErrorMessage;
         _messagesTypes[6171] = ExchangeMountsStableAddMessage;
         _messagesTypes[2211] = ExchangeMountsPaddockAddMessage;
         _messagesTypes[9243] = ExchangeMountsStableBornAddMessage;
         _messagesTypes[7723] = ExchangeMountsStableRemoveMessage;
         _messagesTypes[9179] = ExchangeMountsPaddockRemoveMessage;
         _messagesTypes[9409] = ExchangeMountsTakenFromPaddockMessage;
         _messagesTypes[3765] = ExchangeMountFreeFromPaddockMessage;
         _messagesTypes[815] = ExchangeMountSterilizeFromPaddockMessage;
         _messagesTypes[4871] = ExchangeBidSearchOkMessage;
         _messagesTypes[6889] = ExchangeItemAutoCraftStopedMessage;
         _messagesTypes[9704] = ExchangeStartOkCraftMessage;
         _messagesTypes[667] = ExchangeStartOkCraftWithInformationMessage;
         _messagesTypes[5257] = ExchangeStartOkMulticraftCrafterMessage;
         _messagesTypes[1690] = ExchangeStartOkMulticraftCustomerMessage;
         _messagesTypes[9509] = ExchangeCrafterJobLevelupMessage;
         _messagesTypes[6806] = ExchangeStartOkJobIndexMessage;
         _messagesTypes[2371] = ExchangeCraftPaymentModifiedMessage;
         _messagesTypes[7786] = UpdateMountCharacteristicsMessage;
         _messagesTypes[2362] = ObjectAveragePricesErrorMessage;
         _messagesTypes[1826] = ObjectAveragePricesMessage;
         _messagesTypes[4693] = PurchasableDialogMessage;
         _messagesTypes[9959] = AccountHouseMessage;
         _messagesTypes[8249] = HousePropertiesMessage;
         _messagesTypes[2521] = HouseBuyResultMessage;
         _messagesTypes[3639] = HouseSellingUpdateMessage;
         _messagesTypes[4934] = HouseToSellListMessage;
         _messagesTypes[6026] = HouseGuildNoneMessage;
         _messagesTypes[6276] = HouseGuildRightsMessage;
         _messagesTypes[3041] = PaddockBuyResultMessage;
         _messagesTypes[2585] = PaddockPropertiesMessage;
         _messagesTypes[5153] = PaddockSellBuyDialogMessage;
         _messagesTypes[4049] = GameDataPlayFarmObjectAnimationMessage;
         _messagesTypes[5260] = PaddockToSellListMessage;
         _messagesTypes[401] = HavenBagRoomUpdateMessage;
         _messagesTypes[6628] = HavenBagPackListMessage;
         _messagesTypes[7564] = EditHavenBagStartMessage;
         _messagesTypes[7808] = EditHavenBagFinishedMessage;
         _messagesTypes[9459] = HavenBagDailyLoteryMessage;
         _messagesTypes[7583] = HavenBagFurnituresMessage;
         _messagesTypes[8421] = MapComplementaryInformationsDataInHavenBagMessage;
         _messagesTypes[6604] = HavenBagPermissionsUpdateMessage;
         _messagesTypes[5448] = InviteInHavenBagClosedMessage;
         _messagesTypes[7102] = InviteInHavenBagMessage;
         _messagesTypes[4189] = InviteInHavenBagOfferMessage;
         _messagesTypes[1256] = MountSterilizedMessage;
         _messagesTypes[3377] = MountReleasedMessage;
         _messagesTypes[2387] = MountRenamedMessage;
         _messagesTypes[6887] = MountXpRatioMessage;
         _messagesTypes[6396] = MountDataMessage;
         _messagesTypes[9825] = MountDataErrorMessage;
         _messagesTypes[1810] = MountSetMessage;
         _messagesTypes[2493] = MountUnSetMessage;
         _messagesTypes[1579] = MountEquipedErrorMessage;
         _messagesTypes[3202] = MountRidingMessage;
         _messagesTypes[493] = GameDataPaddockObjectRemoveMessage;
         _messagesTypes[7219] = GameDataPaddockObjectAddMessage;
         _messagesTypes[2396] = GameDataPaddockObjectListAddMessage;
         _messagesTypes[2092] = MountEmoteIconUsedOkMessage;
         _messagesTypes[8820] = LockableShowCodeDialogMessage;
         _messagesTypes[8546] = LockableCodeResultMessage;
         _messagesTypes[6544] = LockableStateUpdateAbstractMessage;
         _messagesTypes[9546] = LockableStateUpdateHouseDoorMessage;
         _messagesTypes[1022] = LockableStateUpdateStorageMessage;
         _messagesTypes[9516] = DocumentReadingBeginMessage;
         _messagesTypes[5152] = TitlesAndOrnamentsListMessage;
         _messagesTypes[6907] = TitleGainedMessage;
         _messagesTypes[2108] = TitleLostMessage;
         _messagesTypes[1948] = OrnamentGainedMessage;
         _messagesTypes[3219] = OrnamentLostMessage;
         _messagesTypes[6156] = TitleSelectedMessage;
         _messagesTypes[4264] = TitleSelectErrorMessage;
         _messagesTypes[7319] = OrnamentSelectedMessage;
         _messagesTypes[1219] = OrnamentSelectErrorMessage;
         _messagesTypes[3320] = ContactLookMessage;
         _messagesTypes[4795] = ContactLookErrorMessage;
         _messagesTypes[299] = SocialNoticeMessage;
         _messagesTypes[5287] = BulletinMessage;
         _messagesTypes[6404] = SocialNoticeSetErrorMessage;
         _messagesTypes[6566] = AccessoryPreviewErrorMessage;
         _messagesTypes[7967] = AccessoryPreviewMessage;
         _messagesTypes[7137] = HaapiBufferListMessage;
         _messagesTypes[9679] = HaapiConfirmationMessage;
         _messagesTypes[9834] = HaapiValidationMessage;
         _messagesTypes[8374] = HaapiBuyValidationMessage;
         _messagesTypes[6269] = HaapiApiKeyMessage;
         _messagesTypes[7752] = HaapiShopApiKeyMessage;
         _messagesTypes[6938] = FinishMoveListMessage;
         _messagesTypes[5524] = TreasureHuntShowLegendaryUIMessage;
         _messagesTypes[8212] = TreasureHuntRequestAnswerMessage;
         _messagesTypes[1177] = TreasureHuntMessage;
         _messagesTypes[3763] = TreasureHuntFinishedMessage;
         _messagesTypes[1144] = TreasureHuntDigRequestAnswerMessage;
         _messagesTypes[2169] = TreasureHuntDigRequestAnswerFailedMessage;
         _messagesTypes[8049] = TreasureHuntFlagRequestAnswerMessage;
         _messagesTypes[3481] = TreasureHuntAvailableRetryCountUpdateMessage;
         _messagesTypes[5061] = BreachStateMessage;
         _messagesTypes[7775] = BreachCharactersMessage;
         _messagesTypes[3446] = BreachBonusMessage;
         _messagesTypes[1127] = BreachBudgetMessage;
         _messagesTypes[1056] = BreachSavedMessage;
         _messagesTypes[8279] = BreachBranchesMessage;
         _messagesTypes[3545] = BreachRewardsMessage;
         _messagesTypes[4972] = BreachRewardBoughtMessage;
         _messagesTypes[5085] = BreachInvitationOfferMessage;
         _messagesTypes[5687] = BreachInvitationResponseMessage;
         _messagesTypes[2489] = BreachInvitationCloseMessage;
         _messagesTypes[2142] = BreachKickResponseMessage;
         _messagesTypes[6582] = AnomalySubareaInformationResponseMessage;
         _messagesTypes[1873] = AlignmentWarEffortProgressionMessage;
         _messagesTypes[8352] = CharacterAlignmentWarEffortProgressionMessage;
         _messagesTypes[3889] = AlignmentWarEffortDonatePreviewMessage;
         _messagesTypes[5546] = AlignmentWarEffortDonationResultMessage;
         _messagesTypes[8146] = HaapiTokenMessage;
         _messagesTypes[6249] = HaapiAuthErrorMessage;
         _messagesTypes[5346] = HaapiSessionMessage;
         _messagesTypes[2421] = DebtsUpdateMessage;
         _messagesTypes[5799] = DebtsDeleteMessage;
         _messagesTypes[542] = ActivitySuggestionsMessage;
         _unpackModes[2079] = UnpackMode.ASYNC;
      }
